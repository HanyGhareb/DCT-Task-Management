...
'and pb.expenditure_type like ''428%''',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(142402742835450)
...
'    :P22_ALLOCATED_AMOUNT,',
'    :P22_LINE_DESCRIPTION',
'from task t, expenditure e',
'where t.project_number = e.project_number',
'and t.task_number = e.task_number',
'and t.project_number = :P22_PROJECT_NUMBER',
'and t.task_number = :P22_TASK_NUMBER',
'and e.expenditure_type = :P22_EXPENDITURE_TYPE ;    '))
