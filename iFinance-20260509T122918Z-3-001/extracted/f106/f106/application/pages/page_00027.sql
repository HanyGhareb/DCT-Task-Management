...
,p_read_only_when=>'PERSON_ID'
,p_read_only_when2=>'680461'
,p_last_updated_by=>'TCA9051'
,p_last_upd_yyyymmddhh24miss=>'20230720071024'
);
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45301283044216711)
,p_name=>'P27_APPLY_EXCEPTION'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(1265093260674893)
,p_item_source_plug_id=>wwv_flow_api.id(1265093260674893)
,p_prompt=>'Apply Exception ?'
,p_source=>'APPLY_EXCEPTION'
