...
,p_last_upd_yyyymmddhh24miss=>'20230720071415'
);
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(45301221657216710)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(45301146397216709)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(45300960919216708)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(45300854372216707)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(45300810645216706)
,p_db_column_name=>'APPLY_EXCEPTION'
,p_display_order=>70
,p_column_identifier=>'Y'
,p_column_label=>'Apply Exception ?'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_column_alignment=>'CENTER'
,p_rpt_named_lov=>wwv_flow_api.id(109820486212935961)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'AP_TRX_CODE:SUPPLIER_NAME:SUPPLIER_NUM:SITE_NAME:INVOICE_TYPE:OU_NAME:CURRENCY:PAYMENT_METHOD:PAY_GROUP:PAYMENT_TERM:PROJECT_ORG:VERSION:STATUS:START_DATE:END_DATE::HEADER_CONTEXT:PAY_ALONE:CREATE_PV_AFTER_CONFIRM:ALLOW_MULTI_REQUESTS:APPLY_EXCEPTION'
);
wwv_flow_api.create_page_plug(
