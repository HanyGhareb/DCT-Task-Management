...
,p_name=>'Mission Approve/Reject Action'
,p_alias=>'MISSION-APPROVE-REJECT-ACTION'
,p_page_mode=>'MODAL'
,p_step_title=>'Mission Approve/Reject Action'
...
,p_last_upd_yyyymmddhh24miss=>'20220723133752'
);
...
,p_button_redirect_url=>'f?p=&APP_ID.:22:&SESSION.::&DEBUG.:22:P22_ALLOCATE_BY,P22_REQUEST_ID:P,&P19_REQUEST_ID.'
...
,p_button_image_alt=>'Add'
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_redirect_url=>'f?p=&APP_ID.:22:&SESSION.::&DEBUG.:22:P22_ALLOCATE_BY,P22_REQUEST_ID:G,&P19_REQUEST_ID.'
,p_icon_css_classes=>'fa-plus'
);
wwv_flow_api.create_page_button(
