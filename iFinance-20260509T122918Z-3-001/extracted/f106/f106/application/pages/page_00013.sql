...
,p_last_upd_yyyymmddhh24miss=>'20230720094906'
);
...
,p_plug_display_when_condition=>'P13_REQUEST_STATUS'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(110590309978412281)
...
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_condition=>':P13_REQUEST_ID is not null and :P13_REQUEST_STATUS in (''Approved'') and (:P13_CREATED_BY_PERSON_ID = :PERSON_ID or :P13_REQUEST_FOR = :PERSON_ID or :IS_COMPENSATION_BENIFIT_YN	= ''Y'')'
,p_button_condition_type=>'PLSQL_EXPRESSION'
,p_icon_css_classes=>'fa-send-o'
);
wwv_flow_api.create_page_button(
...
'--:IS_FBP_EMP = ''Y''',
')',
'and (:P13_REQUEST_STATUS not in (''Draft'' , ''Cancel'' , ''Rejected''))'))
,p_button_condition_type=>'PLSQL_EXPRESSION'
...
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_redirect_url=>'f?p=&APP_ID.:19:&SESSION.::&DEBUG.::P19_ACTION,P19_REQUEST_ID:Withdraw,&P13_REQUEST_ID.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'(:P13_CREATED_BY_PERSON_ID = :PERSON_ID )',
'and (:P13_REQUEST_STATUS not in (''Cancel'', ''Withdraw'' , ''Draft''))'))
,p_button_condition_type=>'PLSQL_EXPRESSION'
...
,p_branch_action=>'f?p=&APP_ID.:18:&SESSION.::&DEBUG.::P18_REQUEST_ID:&P13_REQUEST_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
...
'update MISSION_HEADER set REQUEST_STATUS = ''Draft'' where REQUEST_ID = :P13_REQUEST_ID;'))
,p_attribute_02=>'P13_REQUEST_ID'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
