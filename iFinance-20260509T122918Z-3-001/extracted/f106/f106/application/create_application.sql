...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Employee Self Service')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'SSHR810')
...
,p_authentication_id=>wwv_flow_api.id(59990165065672044)
,p_application_tab_set=>1
,p_logo_type=>'IT'
,p_logo=>'#APP_IMAGES#app-54293-logo(1).png'
,p_logo_text=>'<cite>i-<b>finance - Employee Self Services</b></cite>'
...
,p_substitution_value_01=>'Employee Self Services'
,p_last_updated_by=>'TCA9051'
,p_last_upd_yyyymmddhh24miss=>'20240125095904'
