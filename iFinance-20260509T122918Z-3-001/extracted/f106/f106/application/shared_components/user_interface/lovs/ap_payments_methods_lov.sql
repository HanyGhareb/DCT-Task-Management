prompt --application/shared_components/user_interface/lovs/ap_payments_methods_lov
begin
--   Manifest
--     AP PAYMENTS METHODS LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(1319083099548486)
,p_lov_name=>'AP PAYMENTS METHODS LOV'
