prompt --application/shared_components/email/templates/action_required_mission_old
begin
--   Manifest
--     REPORT LAYOUT: Action Required Mission OLD
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(44985754036141305)
,p_name=>'Action Required Mission OLD'
,p_static_id=>'ACTION_REQUIRED_MISSION_OLD'
,p_subject=>'#SUBJECT#'
...
'<table style="height: 136px; width: 100%; border-collapse: collapse; border-style: none;">',
'<tbody>',
...
'</tr>',
'<tr>',
'<td style="width: 29.0511%;"><strong>Employee Number</strong></td>',
'<td style="width: 70.9489%;">: #EMPLOYEE_NUMBER#</td>',
'</tr>',
'<tr>',
'<td style="width: 29.0511%;"><strong>Grade</strong></td>',
'<td style="width: 70.9489%;">: #GARDE#</td>',
'</tr>',
'<tr>',
'<td style="width: 29.0511%;"><strong>Grade Rate</strong></td>',
'<td style="width: 70.9489%;">: #GARDE_RATE# <strong>AED</strong></td>',
'</tr>',
'<tr style="height: 18px;">',
...
'<tbody>',
'<tr style="height: 18px;">',
'<td style="width: 29.0083%; height: 18px;"><strong>Pay Alone</strong></td>',
'<td style="width: 70.9917%; height: 18px;">: #PAY_ALONE#</td>',
'</tr>',
'<tr style="height: 18px;">',
'<td style="width: 29.0083%; height: 18px;"><strong>Payment Method</strong></td>',
'<td style="width: 70.9917%; height: 18px;">: #PAYMENT_METHOD#</td>',
'</tr>',
'<tr style="height: 18px;">',
'<td style="width: 29.0083%; height: 18px;"><strong>Invoice Type</strong></td>',
'<td style="width: 70.9917%; height: 18px;">: #INVOICE_TYPE#</td>',
'</tr>',
'<tr style="height: 18px;">',
'<td style="width: 29.0083%; height: 18px;"><strong>Supplier</strong></td>',
'<td style="width: 70.9917%; height: 18px;">: #SUPPLIER# (#SITE_NAME#)</td>',
'</tr>',
'<tr style="height: 18px;">',
'<td style="width: 29.0083%; height: 18px;"><strong>Bank Name&nbsp;</strong></td>',
'<td style="width: 70.9917%; height: 18px;">: #BANK_NAME#</td>',
'</tr>',
'<tr style="height: 18px;">',
'<td style="width: 29.0083%; height: 18px;"><strong>IBAN</strong></td>',
'<td style="width: 70.9917%; height: 18px;">: #IBAN#</td>',
'</tr>',
'</tbody>',
'</table>',
'<p>&nbsp;</p>',
...
'APDT001',
'</div>'))
,p_comment=>'Old template with Employee Bank account details'
);
