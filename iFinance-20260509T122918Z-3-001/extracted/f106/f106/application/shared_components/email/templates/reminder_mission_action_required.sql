prompt --application/shared_components/email/templates/reminder_mission_action_required
begin
--   Manifest
--     REPORT LAYOUT: Reminder Mission Action required
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(110393088229570601)
,p_name=>'Reminder Mission Action required'
,p_static_id=>'REMINDER_MISSION_ACTION_REQUIRED'
,p_subject=>'Reminder- Action Required - #REQUEST_TYPE# request for #REQUESTOR#,  Amount: #AMOUNT# AED.'
...
'<p>your kind attention is required for below #REQUEST_TYPE# Request #REQUEST_NO# from<span style="color: #008000;"><strong> #REQUESTOR#.</strong></span></p>',
