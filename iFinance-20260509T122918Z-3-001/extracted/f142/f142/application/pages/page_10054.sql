...
,p_last_upd_yyyymmddhh24miss=>'20230408113846'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(160186211939220669)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(160186392407220669)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(160186458447220669)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(160186392407220669)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(160186548945220669)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(160186609336220669)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160201493743220682)
,p_name=>'P10054_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(160186211939220669)
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160201859187220682)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160202208703220682)
,p_name=>'P10054_FILED'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(160186211939220669)
,p_prompt=>'Filed'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160202677306220682)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160203062986220683)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160203484950220683)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160203851500220683)
...
,p_lov=>'.'||wwv_flow_api.id(160203906609220683)||'.'
,p_field_template=>wwv_flow_api.id(159923872371220121)
,p_lov_display_extra=>'NO'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160206159080220684)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160206535831220684)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(160186757276220669)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(160186548945220669)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(160207321418220685)
,p_event_id=>wwv_flow_api.id(160186757276220669)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(160207807161220685)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(160208236190220685)
,p_process_sequence=>10
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(160186458447220669)
,p_process_success_message=>'Action Processed.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(160208694537220685)
...
'    p_feedback_id        => :P10054_ID );'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(160186609336220669)
,p_process_success_message=>'Action Processed.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(160209098463220687)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(160209445562220687)
