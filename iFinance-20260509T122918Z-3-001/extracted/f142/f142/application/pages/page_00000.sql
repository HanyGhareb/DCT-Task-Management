...
,p_last_upd_yyyymmddhh24miss=>'20231203225307'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(211497567184005147)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(211497632456005148)
,p_event_id=>wwv_flow_api.id(211497567184005147)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(211497757114005149)
,p_event_id=>wwv_flow_api.id(211497567184005147)
,p_event_result=>'TRUE'
