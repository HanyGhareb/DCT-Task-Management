...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(160168506974220647)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(160168673647220647)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(160168741861220647)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(160168506974220647)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(160168876197220647)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(160171480162220648)
,p_branch_name=>'Go To Next Step'
,p_branch_action=>'f?p=&APP_ID.:10044:&SESSION.::&DEBUG.:RP,10044::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(160168741861220647)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160171861047220649)
,p_name=>'P10043_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(160168673647220647)
,p_item_default=>'2'
,p_prompt=>'Role'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160172206496220649)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(160172662605220653)
...
,p_lov=>'.'||wwv_flow_api.id(160172788614220654)||'.'
,p_field_template=>wwv_flow_api.id(159924135324220122)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'1'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(160168933687220647)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(160168876197220647)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(160174005489220654)
,p_event_id=>wwv_flow_api.id(160168933687220647)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(160174545801220655)
...
,p_process_when_button_id=>wwv_flow_api.id(160168741861220647)
);
