...
,p_last_upd_yyyymmddhh24miss=>'20220925071033'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(129035066090007633)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(129035193521007634)
,p_event_id=>wwv_flow_api.id(129035066090007633)
,p_event_result=>'TRUE'
...
'FROM',
'    DP_ITEMS_NOTIFICATIONS_V;'))
,p_attribute_05=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(129035254181007635)
,p_event_id=>wwv_flow_api.id(129035066090007633)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(129035313559007636)
,p_event_id=>wwv_flow_api.id(129035066090007633)
,p_event_result=>'TRUE'
