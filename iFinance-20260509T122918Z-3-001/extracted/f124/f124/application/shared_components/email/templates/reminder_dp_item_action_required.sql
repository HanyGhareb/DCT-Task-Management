prompt --application/shared_components/email/templates/reminder_dp_item_action_required
begin
--   Manifest
--     REPORT LAYOUT: Reminder DP Item Action required
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(129946275442504410)
,p_name=>'Reminder DP Item Action required'
,p_static_id=>'REMINDER_DP_ITEM_ACTION_REQUIRED'
,p_subject=>'Reminder- Action Required - Demand Plan Item #REQUEST_NO#'
...
'<pre>your kind attention is required for below <span style="color: #008000;"><strong>#PLANNING_STATUS#</strong></span> Demand Planning Item <span style="color: #008000;"><strong>#REQUEST_NO#</strong></span> from<span style="color: #008000;"><strong> '
||'#REQUESTOR#.</strong></span><br /><br />Comment: <span style="color: #ff0000;">#COMMENT#</span></pre>',
