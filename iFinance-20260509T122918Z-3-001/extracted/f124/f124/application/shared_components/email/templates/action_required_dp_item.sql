prompt --application/shared_components/email/templates/action_required_dp_item
begin
--   Manifest
--     REPORT LAYOUT: Action Required DP Item
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(129944242593666119)
,p_name=>'Action Required DP Item'
,p_static_id=>'ACTION_REQUIRED_DP_ITEM'
,p_subject=>'#SUBJECT#'
