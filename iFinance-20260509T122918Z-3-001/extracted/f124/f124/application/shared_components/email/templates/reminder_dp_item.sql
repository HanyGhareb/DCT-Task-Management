prompt --application/shared_components/email/templates/reminder_dp_item
begin
--   Manifest
--     REPORT LAYOUT: Reminder DP Item
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(11529232870816363)
,p_name=>'Reminder DP Item'
,p_static_id=>'REMINDER_DP_ITEM'
...
'<pre>your kind attention is required to initiate the Scoping document for below demand planning<br />Comment: <span style="color: #ff0000;">#COMMENT#</span></pre>',
'<table style="height: 226px; width: 100%; border-collapse: collapse; border-style: none;" border="1">',
'<tbody>',
'<tr style="height: 18px;">',
'<td style="width: 29.6696%; height: 18px; background-color: #0e6654;"><span style="color: #ffffff;">DP Item Code</span></td>',
'<td style="width: 70.263%; height: 18px;">',
'<pre>#DP_ITEM_CODE#</pre>',
'</td>',
'</tr>',
...
'</table>',
'<p>&nbsp;</p>',
'<p>Don''t hesitat to contact your Procurment business partner for assistance.&nbsp;</p>',
'<p>&nbsp;</p>',
