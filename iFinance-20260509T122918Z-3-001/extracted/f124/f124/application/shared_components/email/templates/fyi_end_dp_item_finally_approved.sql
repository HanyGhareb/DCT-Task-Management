prompt --application/shared_components/email/templates/fyi_end_dp_item_finally_approved
begin
--   Manifest
--     REPORT LAYOUT: FYI End dp Item finally approved
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(129945132178552797)
,p_name=>'FYI End dp Item finally approved'
,p_static_id=>'FYI_END_DP_ITEM_FINALLY_APPROVED'
,p_subject=>'FYI - Item #REQUEST_NO# For #REQUESTOR# has been Approved'
...
'<pre>Kindly not that the <strong>#PLANNING_STATUS#</strong> Demand Planning Item <strong>#REQUEST_NO#</strong> has been finaly approved<strong>.</strong><br /><br />Comment: <span style="color: #ff0000;">#COMMENT#</span></pre>',
