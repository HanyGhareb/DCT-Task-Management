prompt --application/shared_components/user_interface/lovs/dp_item_category_roles
begin
--   Manifest
--     DP ITEM CATEGORY ROLES
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(128421071521237933)
,p_lov_name=>'DP ITEM CATEGORY ROLES'
