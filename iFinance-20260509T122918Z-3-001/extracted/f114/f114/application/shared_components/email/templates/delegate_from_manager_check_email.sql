prompt --application/shared_components/email/templates/delegate_from_manager_check_email
begin
--   Manifest
--     REPORT LAYOUT: Delegate From Manager Check Email
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(54450471525600312)
,p_name=>'Delegate From Manager Check Email'
,p_static_id=>'DELEGATE_FROM_MANAGER_CHECK_EMAIL'
,p_subject=>'Delegate - Manager''s Cheque'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello  <b><span style="color: #0e6654;"><i>#APPROVER_TITL# #APPROVER_EMP_NAME#,</i></span></b>',
'<br>',
'<br>',
'you have delegate below Manager''s Cheque to <span style="color: #0e6654;"><i><b>#DELEGATE_TO_EMP_TITLE# #DELEGATE_TO_EMP_NAME# </b></i></span>  for his/her action.',
'<br>',
'<br>',
'<br>',
'',
