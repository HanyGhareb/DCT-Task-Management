prompt --application/shared_components/email/templates/manager_check_final_approval
begin
--   Manifest
--     REPORT LAYOUT: Manager Check Final Approval
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(53358563812103710)
,p_name=>'Manager Check Final Approval'
,p_static_id=>'MANAGER_CHECK_FINAL_APPROVAL'
,p_subject=>'Cheque No. #CHECK_NUM# Amount #AMOUNT# Released Successfully.'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Dear <span style="color: #ff0000;"><strong>#EMP_TITLE# #APPROVER_EMP_NAME#,</strong></span></p>',
'<p>This is to confirm that cheque Number <strong><span style="color: #ff0000;">#CHECK_NUM#</span></strong> with amount <strong><span style="color: #ff0000;">#AMOUNT# #CURRENCY#</span></strong>. has been released successfully.</p>',
