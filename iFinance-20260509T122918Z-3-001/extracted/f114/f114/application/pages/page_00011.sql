...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(53940384241354379)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(53941080702354380)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(53941312139354380)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(53942575383354380)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(53941312139354380)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(53942225908354380)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(53941721120354380)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(53943383578354381)
,p_branch_action=>'f?p=&APP_ID.:12:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(53942575383354380)
...
'                                      where name = ''Upload Managers Checks'' and application_id = apex_application.g_flow_id )',
'                            loop',
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(53943776750354381)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(53943076961354381)
...
,p_process_when_button_id=>wwv_flow_api.id(53942575383354380)
);
