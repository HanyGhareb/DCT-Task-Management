...
,p_last_upd_yyyymmddhh24miss=>'20220116134211'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(53146497356960310)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53146573063960311)
,p_event_id=>wwv_flow_api.id(53146497356960310)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53146771441960313)
,p_event_id=>wwv_flow_api.id(53146497356960310)
,p_event_result=>'TRUE'
