...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(47696059906449)
,p_parent_id=>wwv_flow_api.id(10191357073597728)
,p_short_name=>'CWIP Users'
,p_link=>'f?p=&APP_ID.:42:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>42
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(567488924599225)
,p_parent_id=>wwv_flow_api.id(10191357073597728)
,p_short_name=>'Dashboard - Drilldown'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(14089175080165209)
,p_parent_id=>wwv_flow_api.id(39956210679840087)
,p_short_name=>'CWIP Payments Delegation - Admin'
,p_link=>'f?p=&APP_ID.:51:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>51
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(14121134783327980)
,p_parent_id=>wwv_flow_api.id(14089175080165209)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(66503708955049075)
,p_parent_id=>wwv_flow_api.id(10191357073597728)
,p_short_name=>'Payment Recommendation Request VIew Only'
,p_link=>'f?p=&APP_ID.:56:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>56
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(84298330857116446)
,p_parent_id=>wwv_flow_api.id(10191357073597728)
,p_short_name=>'Manage Project Status'
,p_link=>'f?p=&APP_ID.:59:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>59
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(84299556767116444)
,p_parent_id=>wwv_flow_api.id(84298330857116446)
,p_short_name=>'Project Status Deatils'
,p_link=>'f?p=&APP_ID.:60:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>60
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(86989696219490953)
,p_parent_id=>wwv_flow_api.id(10191357073597728)
,p_short_name=>'Manage Projects Locations'
,p_link=>'f?p=&APP_ID.:61:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>61
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(86990884654490950)
,p_parent_id=>wwv_flow_api.id(86989696219490953)
,p_short_name=>'Location Details'
,p_link=>'f?p=&APP_ID.:62:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>62
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(99824925864315613)
,p_parent_id=>wwv_flow_api.id(22097380579414298)
,p_short_name=>'Payment Recommendation Details'
,p_link=>'f?p=&APP_ID.:68:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>68
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(99954033273685621)
,p_parent_id=>wwv_flow_api.id(99824925864315613)
,p_short_name=>'Payment documents'
,p_link=>'f?p=&APP_ID.:69:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>69
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(115055223033385025)
,p_parent_id=>wwv_flow_api.id(10191357073597728)
,p_short_name=>'Vendors Bank Accounts'
