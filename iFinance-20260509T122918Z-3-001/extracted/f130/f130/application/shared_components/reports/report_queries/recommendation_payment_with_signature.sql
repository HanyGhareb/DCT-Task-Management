prompt --application/shared_components/reports/report_queries/recommendation_payment_with_signature
begin
--   Manifest
--     WEB SERVICE: Recommendation Payment with Signature
--   Manifest End
...
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(32845889364451941)
,p_name=>'Recommendation Payment with Signature'
...
,p_format=>'PDF'
,p_output_file_name=>'Recommendation Payment with Signature'
,p_content_disposition=>'INLINE'
,p_xml_items=>'P29_PR_ID'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(32848979132444905)
,p_shared_query_id=>wwv_flow_api.id(32845889364451941)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(32849112987444904)
,p_shared_query_id=>wwv_flow_api.id(32845889364451941)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(32849307998444904)
,p_shared_query_id=>wwv_flow_api.id(32845889364451941)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT',
'    id,',
