prompt --application/shared_components/email/templates/payment_recommendation_action_required_email_temp
begin
--   Manifest
--     REPORT LAYOUT: Payment Recommendation Action Required Email Temp
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(39205221679118057)
,p_name=>'Payment Recommendation Action Required Email Temp'
,p_static_id=>'PAYMENT_RECOMMENDATION_ACTION_REQUIRED_EMAIL_TEMP'
,p_subject=>'Action Required- Payment Recommendation #PAYMENT_NUMBER#,IPC: #IPC_NUMBER# for #CONTRACTING_PARTY#'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Dear #APPROVER_TITLE# #APPROVER_NAME#, <br /><br /><br /></p>',
...
'<p>&nbsp;</p>',
'<table style="height: 43px; width: 81.8569%; border-collapse: collapse; margin-left: auto; margin-right: auto;" border="1">',
'<tbody>',
'<tr>',
'<td style="padding: 16px 24px; border-radius: 4px; min-width: 200px; background-color: green; text-align: center;"><span style="color: #ffffff;"><strong><a style="color: #ffffff;" title="Approve through email without login or OTP" href="#DIRECT_APPRO'
||'VE_LINK#" target="_blank" rel="noopener">Approve through email</a></strong></span></td>',
'<td style="width: 2.90398%; border-color: white;">&nbsp;</td>',
'<td style="width: 31.6315%; background-color: blue; text-align: center;"><span style="color: #ffffff;"><strong><a style="color: #ffffff;" title="Approve through i-finance system, you need to login" href="#APPLICATION_LINK#" target="_blank" rel="noope'
||'ner">Approve through i-finance system</a></strong></span></td>',
'<td style="width: 11.8813%; border-color: white;">&nbsp;</td>',
'<td style="width: 28.1187%; background-color: red; text-align: center;"><span style="color: #ffffff;"><strong><a style="color: #ffffff;" title="Reject through email without login or OTP" href="#DIRECT_REJECT_LINK#" target="_blank" rel="noopener">Reje'
||'ct through email</a></strong></span></td>',
'</tr>',
'</tbody>',
'</table>',
'<p>&nbsp;</p>',
