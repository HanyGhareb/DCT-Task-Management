...
,p_subject=>'FYI- Payment Recommendation #PAYMENT_NUMBER#, IPC: #IPC_NUMBER# for #CONTRACTING_PARTY# has been Approved.'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Dear #APPROVER_TITLE# #APPROVER_NAME#,',
'<br>',
'<br>',
'The below Payment Application has been <span style="color: green;"><i><b>approved </b></i></span> by DCT and forwarded to DoF for further processing.',
'<br>',
'Comment: #COMMENT#',
'<br>',
'<br>',
