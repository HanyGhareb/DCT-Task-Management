prompt --application/shared_components/email/templates/fyi_payment_recommendation_submitted_email
begin
--   Manifest
--     REPORT LAYOUT: FYI Payment Recommendation Submitted Email
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(14596200943308680)
,p_name=>'FYI Payment Recommendation Submitted Email'
,p_static_id=>'FYI_PAYMENT_RECOMMENDATION_SUBMITTED_EMAIL'
,p_subject=>'FYI- Payment Recommendation #PAYMENT_NUMBER#,IPC: #IPC_NUMBER# for #CONTRACTING_PARTY# has been Submitted.'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Dear #APPROVER_TITLE# #APPROVER_NAME#,',
'<br>',
'<br>',
'The Below payment recommendation application has been Submitted.',
'',
'<br>',
