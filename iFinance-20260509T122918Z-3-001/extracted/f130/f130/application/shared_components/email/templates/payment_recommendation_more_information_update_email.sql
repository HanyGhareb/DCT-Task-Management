prompt --application/shared_components/email/templates/payment_recommendation_more_information_update_email
begin
--   Manifest
--     REPORT LAYOUT: Payment Recommendation More Information Update Email
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(39298889329877865)
,p_name=>'Payment Recommendation More Information Update Email'
,p_static_id=>'PAYMENT_RECOMMENDATION_MORE_INFORMATION_UPDATE_EMAIL'
,p_subject=>'More Info. Updates- Payment Recommendation #PAYMENT_NUMBER#,IPC: #IPC_NUMBER# for #CONTRACTING_PARTY# .'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Dear #APPROVER_TITLE# #APPROVER_NAME#,',
'<br>',
'<br>',
'You have got updates from <span style="color: #529FEC;"><i><b>#EMP_TITLE# #EMP_NAME# </b></i></span>as below: ',
'<br>',
' <span style="color: #529FEC;"><i><b> #COMMENT#</b></i></span>',
'<br>',
'<br>',
'<table style="height: 356px; width: 120%; border-collapse: collapse;" border="0">',
'<tbody>',
'<tr style="height: 18px;">',
'<td style="width: 99.9999%; height: 18px; background-color: #8dc0f3;" colspan="5"><strong><em>Information Required - Payment </em></strong></td>',
'</tr>',
'<tr style="height: 18px;">',
