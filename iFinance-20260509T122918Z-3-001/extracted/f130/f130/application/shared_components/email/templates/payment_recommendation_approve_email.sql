prompt --application/shared_components/email/templates/payment_recommendation_approve_email
begin
--   Manifest
--     REPORT LAYOUT: Payment Recommendation Approve Email
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(5407726559181880)
,p_name=>'Payment Recommendation Approve Email'
,p_static_id=>'PAYMENT_RECOMMENDATION_APPROVE_EMAIL'
...
'<br>',
'<br>',
'The below Payment Application has been <span style="color: green;"><i><b>approved </b></i></span>.',
'<br>',
'Comment: #COMMENT#',
'<br>',
'<br>',
