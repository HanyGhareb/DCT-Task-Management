...
,p_subject=>'FYI- Payment Recommendation #PAYMENT_NUMBER#, IPC: #IPC_NUMBER# for #CONTRACTING_PARTY# has been Rejected'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Dear #APPROVER_TITLE# #APPROVER_NAME#,',
'<br>',
'<br>',
'The below payment recommendation application has been <span style="color: red;"><i><b>rejected.</b></i></span>',
'<br>',
'Comment: #COMMENT#',
'<br>',
'<br>',
