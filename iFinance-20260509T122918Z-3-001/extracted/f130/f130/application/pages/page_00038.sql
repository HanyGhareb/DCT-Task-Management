...
,p_last_upd_yyyymmddhh24miss=>'20220314075530'
);
...
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--showIcon:t-Region--scrollBody:margin-right-none'
,p_plug_template=>wwv_flow_api.id(10245193460597780)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14392394785263265)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14392548835263266)
,p_plug_name=>'Payment Recommendation Details'
,p_parent_plug_id=>wwv_flow_api.id(102764854457087969)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14934102903770877)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14934172806770878)
...
,p_is_default=>'Y'
,p_view_mode=>'REPORT'
,p_report_columns=>'STEP_NO:FULL_NAME:ROLE_NAME:ACTION_REQUIRED:RECEVIED_DATE:STATUS:ACTION_DATE:REMINDER_COUNT:'
,p_sort_column_1=>'STEP_NO'
,p_sort_direction_1=>'ASC'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(14993068748916436)
...
'and person_id = :P38_PERSON_ID',
'and c.contract_number = (Select x.contract_number',
'                        from cwip_payment_recommendation x',
'                        where x.payment_recommendation_id = :P38_PAYMENT_RECOMMENDATION_ID)',
'and h.status in (''Pending'', ''Rejected'' , ''Returned'')',
'and h.id <> :P38_HISTORY_ID',
...
,p_button_image_alt=>'&P38_APPROVE_LABEL.'
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_redirect_url=>'f?p=&APP_ID.:39:&SESSION.::&DEBUG.:39:P39_ACTION,P39_HASH,P39_HISTORY_ID,P39_PAYMENT_RECOMMENDATION_ID,P39_PERSON_ID,P39_PERSON_TYPE,P39_APPROVE_LABEL,P39_REJECT_LABEL:A,&P38_HASH.,&P38_HISTORY_ID.,&P38_PAYMENT_RECOMMENDATION_ID.,&P38_PERSON_ID.,&P38_PERSON_TYPE.,&P38_APPROVE_LABEL.,&P38_REJECT_LABEL.'
...
,p_button_template_id=>wwv_flow_api.id(10307341140597826)
,p_button_image_alt=>'&P38_REJECT_LABEL.'
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_redirect_url=>'f?p=&APP_ID.:39:&SESSION.::&DEBUG.:39:P39_ACTION,P39_HASH,P39_HISTORY_ID,P39_PAYMENT_RECOMMENDATION_ID,P39_PERSON_ID,P39_PERSON_TYPE,P39_APPROVE_LABEL,P39_REJECT_LABEL:R,&P38_HASH.,&P38_HISTORY_ID.,&P38_PAYMENT_RECOMMENDATION_ID.,&P38_PERSON_ID.,&P38_PERSON_TYPE.,&P38_REJECT_LABEL.,&P38_REJECT_LABEL.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select  c.reference_number',
'from cwip_payment_rec_approval_history h , cwip_payment_recommendation c',
'where h.payment_recommendation_id = c.payment_recommendation_id',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14393824669263279)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(102764854457087969)
,p_button_name=>'Hold'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--warning:t-Button--iconRight:t-Button--gapLeft'
,p_button_template_id=>wwv_flow_api.id(10307341140597826)
,p_button_image_alt=>'Hold'
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_redirect_url=>'f?p=&APP_ID.:39:&SESSION.::&DEBUG.:39:P39_ACTION,P39_HASH,P39_HISTORY_ID,P39_PAYMENT_RECOMMENDATION_ID,P39_PERSON_ID,P39_PERSON_TYPE:H,&P38_HASH.,&P38_HISTORY_ID.,&P38_PAYMENT_RECOMMENDATION_ID.,&P38_PERSON_ID.,&P38_PERSON_TYPE.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select  c.reference_number',
'from cwip_payment_rec_approval_history h , cwip_payment_recommendation c',
'where h.payment_recommendation_id = c.payment_recommendation_id',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4999421649563953)
,p_name=>'P38_APPROVE_LABEL'
,p_item_sequence=>60
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4999524081563954)
,p_name=>'P38_REJECT_LABEL'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(109161443064251107)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5000941548563968)
,p_name=>'P38_LIST'
,p_item_sequence=>310
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14391879022263260)
,p_name=>'P38_VENDOR_NAME'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(14392394785263265)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14391982048263261)
,p_name=>'P38_CONTRACT_DESCRIPTION'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(14392394785263265)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14392073714263262)
,p_name=>'P38_INITIAL_CONTRACT_AMOUNT'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(14392394785263265)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14392207282263263)
,p_name=>'P38_VARIATION_AMOUNT'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(14392394785263265)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14392354697263264)
,p_name=>'P38_CONTRACT_AMOUNT'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(14392394785263265)
...
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(14392548835263266)
,p_item_source_plug_id=>wwv_flow_api.id(102764854457087969)
...
'+ to_number(replace(nvl(:P38_PPREVIOUSELY_CERIFIED_PENDING,0),'','','''') )',
'+ to_number(replace(nvl(:P38_NET_AMOUNT_PAYABLE,0),'','','''') ),''99,999,999,999.99''))  as amount',
'from dual'))
,p_source_type=>'QUERY'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>20
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(5000445225563963)
,p_name=>'Show Previous Payments not approved DA'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P38_PREVIOUS_PAYMENT_APPROVED'
,p_condition_element=>'P38_PREVIOUS_PAYMENT_APPROVED'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(5000487718563964)
,p_event_id=>wwv_flow_api.id(5000445225563963)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(109161443064251107)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(5000607365563965)
,p_event_id=>wwv_flow_api.id(5000445225563963)
...
'case h.action_required when ''Recommend/Return'' Then ''Recommend''',
'                       when ''Approve/Reject''   Then ''Approve''',
'End as approve_label',
',case h.action_required when ''Recommend/Return'' Then ''Return''',
'                       when ''Approve/Reject''   Then ''Reject''',
'End as reject_label',
'into :P38_HISTORY_ID, :P38_PAYMENT_RECOMMENDATION_ID , :P38_PERSON_ID , :P38_PERSON_TYPE , :P38_APPROVE_LABEL, :P38_REJECT_LABEL',
'from CWIP_PAYMENT_REC_APPROVAL_HISTORY h',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14391797274263259)
...
'into :P38_VENDOR_NAME, ',
'     :P38_CONTRACT_DESCRIPTION, ',
'--     DCT_DESCRIPTION, ',
'     :P38_INITIAL_CONTRACT_AMOUNT, ',
'     :P38_VARIATION_AMOUNT, ',
'     :P38_CONTRACT_AMOUNT',
'from cwip_contracts_v',
'where CONTRACT_NUMBER = (select x.CONTRACT_NUMBER',
'                        from cwip_payment_recommendation x',
'                        where x.payment_recommendation_id = (select h.payment_recommendation_id ',
'                                                                from CWIP_PAYMENT_REC_APPROVAL_HISTORY h',
'                                                                        where hash_code = :P38_Hash',
'                                                                        and h.status = ''Pending''));',
'exception',
