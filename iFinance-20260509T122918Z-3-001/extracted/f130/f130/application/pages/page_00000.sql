...
,p_last_upd_yyyymmddhh24miss=>'20231018230054'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(12358446050862824)
,p_name=>'Show Notification'
,p_event_sequence=>10
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
,p_display_when_type=>'CURRENT_PAGE_NOT_IN_CONDITION'
,p_display_when_cond=>'9999,38,39,40,57'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(12358571025862825)
,p_event_id=>wwv_flow_api.id(12358446050862824)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(21268312357381909)
,p_event_id=>wwv_flow_api.id(12358446050862824)
,p_event_result=>'TRUE'
...
'           end IMAGE  ',
'-- ,apex_util.prepare_url( ''f?p=''||:APP_ID||'':2:''||:APP_SESSION||''::NO::P2_PERSON_ID:''|| PERSON_ID ) EDIT_LINK',
', Null EDIT_LINK',
', LOWER(email) EMAIL',
', NVL(MOBILE, ''NA'') PHONE_NO',
