...
,p_last_upd_yyyymmddhh24miss=>'20220719112745'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112538064569334447)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(39967597370811309)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(112538064569334447)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39967955134811309)
,p_name=>'P45_NOTES'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(112538064569334447)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(39968378205811306)
,p_name=>'Send EmailOnClick'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(39967597370811309)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39969810115811305)
,p_event_id=>wwv_flow_api.id(39968378205811306)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39968839840811305)
,p_event_id=>wwv_flow_api.id(39968378205811306)
,p_event_result=>'TRUE'
...
'        p_bcc               => ''ifinance@dctabudhabi.ae'' ,   ',
'        p_to                 => apex_exec.get_varchar2( l_context, l_emailsidx ),',
'        p_template_static_id => ''CWIP_PAYMENT_INVITATION'',',
'        p_placeholders       => ''{'' ||',
...
'        ''   ,"NOTES":''               || apex_json.stringify( :P45_NOTES ) ||    ',
...
'     raise; ',
'end;'))
,p_attribute_02=>'P45_NOTES'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39969357222811305)
,p_event_id=>wwv_flow_api.id(39968378205811306)
,p_event_result=>'TRUE'
