...
,p_last_upd_yyyymmddhh24miss=>'20231202205224'
);
...
,p_button_condition=>'P23_PAGE_FROM'
,p_button_condition2=>'21'
,p_button_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(168268233000677265)
...
,p_button_image_alt=>'Cancel'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_button_redirect_url=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.::P24_PROJECT_NUMBER,P24_CONTRACT_NUMBER:&P23_PROJECT_NUMBER.,&P23_CONTRACT_NUMBER.'
,p_button_condition=>'P23_PAGE_FROM'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(168268141575677264)
,p_name=>'P23_PAGE_FROM'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(23532024880266526)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
