...
,p_last_upd_yyyymmddhh24miss=>'20240304083915'
);
...
,p_button_condition=>'P22_PAGE_FROM'
,p_button_condition2=>'21'
,p_button_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(168267967439677263)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(11734709560371499)
,p_button_name=>'CANCEL_24'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(10307273349597826)
,p_button_image_alt=>'Cancel'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_button_redirect_url=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.::P24_CONTRACT_NUMBER,P24_PROJECT_NUMBER:&P22_CONTRACT_NUMBER.,&P22_PROJECT_NUMBER.'
,p_button_condition=>'P22_PAGE_FROM'
,p_button_condition2=>'24'
,p_button_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
);
wwv_flow_api.create_page_button(
...
,p_branch_condition=>'P22_CONTRACT_NUMBER'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(168267758209677261)
,p_branch_name=>'Go To Page 24'
,p_branch_action=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.::P24_CONTRACT_NUMBER:&P22_CONTRACT_NUMBER.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(168267859505677262)
,p_name=>'P22_PAGE_FROM'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(11734145767371463)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
