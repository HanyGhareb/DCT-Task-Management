...
,p_last_upd_yyyymmddhh24miss=>'20220801100705'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14393162980263273)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14393289399263274)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14393386864263275)
,p_plug_name=>'Audit'
,p_parent_plug_id=>wwv_flow_api.id(44561707013752241)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14392690909263268)
,p_name=>'P28_VENDOR_NAME'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(14393162980263273)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14392773952263269)
,p_name=>'P28_CONTRACT_DESCRIPTION'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(14393162980263273)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14392863789263270)
,p_name=>'P28_INITIAL_CONTRACT_AMOUNT'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(14393162980263273)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14392997967263271)
,p_name=>'P28_VARIATION_AMOUNT'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(14393162980263273)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14393089751263272)
,p_name=>'P28_CONTRACT_AMOUNT'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(14393162980263273)
...
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(14393289399263274)
,p_item_source_plug_id=>wwv_flow_api.id(44561707013752241)
...
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(14393386864263275)
,p_item_source_plug_id=>wwv_flow_api.id(44561707013752241)
,p_prompt=>'Created By'
,p_source=>'CREATED_BY'
,p_source_type=>'REGION_SOURCE_COLUMN'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14392575281263267)
...
'into :P28_VENDOR_NAME, ',
'     :P28_CONTRACT_DESCRIPTION, ',
'--     DCT_DESCRIPTION, ',
'     :P28_INITIAL_CONTRACT_AMOUNT, ',
'     :P28_VARIATION_AMOUNT, ',
'     :P28_CONTRACT_AMOUNT',
'from cwip_contracts_v',
'where CONTRACT_NUMBER = (select x.CONTRACT_NUMBER',
'                        from cwip_payment_recommendation x',
'                        where x.payment_recommendation_id = :P28_PAYMENT_RECOMMENDATION_ID);'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71136810100892571)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Reply Process'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'cwip_rec_payment_workflow.MORE_INFO_REPLY(:P28_PAYMENT_RECOMMENDATION_ID,:P28_FROM_PERSON_ID,:P28_FROM_PERSON_TYPE, :P28_TO_PERSON_ID, :P28_TO_PERSON_TYPE, :P28_REPLY);',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(21046957502738270)
,p_process_success_message=>'your reply has been sent.'
);
wwv_flow_api.create_page_process(
