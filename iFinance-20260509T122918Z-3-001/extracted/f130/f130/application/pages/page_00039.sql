...
,p_last_upd_yyyymmddhh24miss=>'20220409132028'
);
...
,p_button_image_alt=>'&P39_APPROVE_LABEL.'
...
,p_button_template_id=>wwv_flow_api.id(10307341140597826)
,p_button_image_alt=>'&P39_REJECT_LABEL.'
,p_button_position=>'BELOW_BOX'
,p_button_condition=>'P39_ACTION'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14393947794263280)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4999582140563955)
,p_name=>'P39_APPROVE_LABEL'
,p_item_sequence=>90
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4999679051563956)
,p_name=>'P39_REJECT_LABEL'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(79405467992047947)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
'',
'',
'cwip_rec_payment_workflow.hold(:P39_PAYMENT_RECOMMENDATION_ID,:P39_PERSON_ID, :P39_COMMENT);',
'',
'End if;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
