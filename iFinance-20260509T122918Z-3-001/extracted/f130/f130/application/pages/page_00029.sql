...
,p_last_upd_yyyymmddhh24miss=>'20240227155603'
);
...
' --     , h.LAST_REMINDER_ON + INTERVAL ''0 04:00:00.0'' DAY TO SECOND LAST_REMINDER_ON',
'        , h.LAST_REMINDER_ON + INTERVAL ''0 04:00:00.0'' DAY TO SECOND LAST_REMINDER_ON',
'      , h.REMINDER_BY',
...
,p_max_row_count=>'1000000'
,p_no_data_found_message=>'Approval Details Not Available'
,p_report_list_mode=>'TABS'
,p_show_detail_link=>'N'
,p_show_notify=>'Y'
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14612813795388540)
,p_db_column_name=>'REMINDER_COUNT'
,p_display_order=>210
,p_column_identifier=>'U'
,p_column_label=>'Reminder Count'
,p_column_link=>'f?p=&APP_ID.:55:&SESSION.::&DEBUG.:55:P55_PAYMENT_RECOMMENDATION_ID,P55_PPERSON_ID,P55_HISTORY_ID:#PAYMENT_RECOMMENDATION_ID#,#PERSON_ID#,#ID#'
,p_column_linktext=>'#REMINDER_COUNT#'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14612951975388541)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14612960194388542)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(14739250208309005)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86724769514706334)
...
,p_plug_name=>'Payment Recommendation Details'
,p_parent_plug_id=>wwv_flow_api.id(86724769514706334)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86644725087269938)
...
,p_parent_plug_id=>wwv_flow_api.id(86644725087269938)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86644762064269939)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86647833627269969)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86647952751269970)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86648034393269971)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86648067715269972)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86648799716269979)
,p_plug_name=>'Audit Info'
,p_parent_plug_id=>wwv_flow_api.id(86644725087269938)
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:js-useLocalStorage:is-collapsed:t-Region--noBorder:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(10228155320597771)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(99632585466221660)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(99632689911221661)
,p_branch_name=>'Go to Edit Page 68'
,p_branch_action=>'f?p=&APP_ID.:68:&SESSION.::&DEBUG.:68:P68_PAYMENT_RECOMMENDATION_ID,P68_REFERENCE_CODE:&P29_PAYMENT_RECOMMENDATION_ID.,&P29_REFERENCE_CODE.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(99632585466221660)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
...
,p_format_mask=>'999G999G999G999G990D00'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select trim(to_char(Previousely_Cerified_Approved,''9,999,999,999.99''))',
'from ',
'(SELECT',
'    payment_recommendation_id,',
'    (',
...
,p_post_element_text=>'&nbsp; &P29_CURRENCY.'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select trim(to_char(Previousely_Cerified_Pending,''9,999,999,999.99''))',
'from ',
'(SELECT',
'    payment_recommendation_id,',
'    (',
...
'+ to_number(replace(nvl(:P29_NET_AMOUNT_PAYABLE,0),'','','''') ),''9,999,999,999.99''))  as amount',
'from dual'))
,p_source_type=>'QUERY'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>20
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86644948985269940)
,p_name=>'P29_REFERENCE_NUMBER2'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
,p_item_source_plug_id=>wwv_flow_api.id(45528463563636221)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645041422269941)
,p_name=>'P29_DATE_PREPARED'
,p_source_data_type=>'TIMESTAMP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
,p_item_source_plug_id=>wwv_flow_api.id(45528463563636221)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645153213269942)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645182705269943)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645312197269944)
,p_name=>'P29_CONTRACTING_PARTY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645451155269945)
,p_name=>'P29_AGREEMENT_PERIOD'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645519523269946)
,p_name=>'P29_CONTRACT_TITLE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645613007269947)
,p_name=>'P29_ORIGINAL_AGREEMENT_FEE'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645732197269948)
,p_name=>'P29_AGREEMENT_REF'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645835524269949)
,p_name=>'P29_APPROVED_VARIATION'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645904601269950)
,p_name=>'P29_PURCHASE_ORDER'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86645981843269951)
,p_name=>'P29_REVISED_AGREEMENT_FEE'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86646075866269952)
,p_name=>'P29_INVOICE_NUM2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(86647833627269969)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86646251919269953)
,p_name=>'P29_INVOICE_DATE2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(86647833627269969)
,p_prompt=>'Dated :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86646261760269954)
,p_name=>'P29_TOTAL_INVOICE_AMOUNT2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(86647833627269969)
,p_prompt=>'Invoice Amount (Including VAT) :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86646423315269955)
,p_name=>'P29_PAYMENT_TYPE2'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(86647952751269970)
,p_prompt=>'Payment Type :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(10305900021597823)
,p_item_template_options=>'#DEFAULT#:margin-left-none'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86646522910269956)
,p_name=>'P29_CUMULATIVE_CERTIFIED_TO_DATE'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(86647952751269970)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86646621607269957)
,p_name=>'P29_CERTIFIED_DATE'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(86647952751269970)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86646707308269958)
,p_name=>'P29_PREVIOUSLY_CERTIFIED'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(86647952751269970)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86646851544269959)
,p_name=>'P29_CURRENCY2'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_api.id(86647952751269970)
,p_prompt=>'Currency :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86646909476269960)
,p_name=>'P29_DUE_AMOUNT_WITHOUT_VAT'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_api.id(86647952751269970)
,p_prompt=>'Due Amount :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86647034151269961)
,p_name=>'P29_DUE_AMOUNT_WITH_VAT_WORDS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(86648034393269971)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86647078415269962)
,p_name=>'P29_CURRENT_VALUATION_AMOUNT2'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
,p_prompt=>'Current Valuation Amount :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86647209213269963)
,p_name=>'P29_PERIOD2'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86647353943269964)
,p_name=>'P29_DEDUCTIONS2'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
,p_prompt=>'Deductions :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86647367417269965)
,p_name=>'P29_SCOPE_OF_WORK2'
,p_item_sequence=>260
,p_item_plug_id=>wwv_flow_api.id(86648067715269972)
,p_prompt=>'Scope Of Work :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(10305900021597823)
,p_item_template_options=>'#DEFAULT#:margin-left-none'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86647530914269966)
,p_name=>'P29_REMARK2'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_api.id(86648067715269972)
,p_prompt=>'Remark :'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86647626640269967)
,p_name=>'P29_APPROVAL_STATUS2'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(86644762064269939)
,p_prompt=>'Approval Status :'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86648234132269973)
,p_name=>'P29_TOTAL_INVOICE_AMOUNT3'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(86648034393269971)
,p_prompt=>'Total Invoice Amount3'
,p_source=>'P29_TOTAL_INVOICE_AMOUNT2'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_begin_on_new_line=>'N'
,p_grid_column=>9
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86648875691269980)
,p_name=>'P29_CREATED_BY_1'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(86648799716269979)
,p_item_source_plug_id=>wwv_flow_api.id(45528463563636221)
,p_prompt=>'<span style="font-weight: bold;font-size:12px;color:#368ed2;">Created By :</span>'
,p_source=>'CREATED_BY'
,p_source_type=>'REGION_SOURCE_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86724481708706331)
,p_name=>'P29_CREATED_ON_1'
,p_source_data_type=>'TIMESTAMP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(86648799716269979)
,p_item_source_plug_id=>wwv_flow_api.id(45528463563636221)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86724609658706332)
,p_name=>'P29_UPDATED_BY_1'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(86648799716269979)
,p_item_source_plug_id=>wwv_flow_api.id(45528463563636221)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86724706467706333)
,p_name=>'P29_UPDATED_ON_1'
,p_source_data_type=>'TIMESTAMP'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(86648799716269979)
,p_item_source_plug_id=>wwv_flow_api.id(45528463563636221)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100886790441036233)
,p_name=>'P29_REFERENCE_CODE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(86647833627269969)
...
'  into l_project_code',
'  from project p',
'  where p.project_number = :P29_PROJECT_NUMBER;',
'  ',
'  SELECT nvl(c.dct_contract_code,''XXX'')',
'   into    l_contract_code',
'  FROM cwip_contract c',
'  where c.contract_number = :P29_CONTRACT_NUMBER;',
'  ',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(86647731214269968)
...
'into',
'    :P29_REFERENCE_NUMBER2,',
'    :P29_DATE_PREPARED,',
'    :P29_PROJECT_NAME,',
'    :P29_PROJECT_NUMBER,',
'    :P29_EFFECTIVE_DATE,',
'    :P29_CONTRACTING_PARTY,',
'    :P29_AGREEMENT_PERIOD,',
'    :P29_CONTRACT_TITLE,',
'    :P29_ORIGINAL_AGREEMENT_FEE,',
'    :P29_AGREEMENT_REF,',
'    :P29_APPROVED_VARIATION,',
'    :P29_PURCHASE_ORDER,',
'    :P29_REVISED_AGREEMENT_FEE,',
'    :P29_INVOICE_NUM2,',
'    :P29_INVOICE_DATE2,',
'    :P29_TOTAL_INVOICE_AMOUNT2,',
'    :P29_PAYMENT_TYPE2,',
'    :P29_CUMULATIVE_CERTIFIED_TO_DATE,',
'    :P29_CERTIFIED_DATE,',
'    :P29_PREVIOUSLY_CERTIFIED,',
'    :P29_CURRENCY2,',
'    :P29_DUE_AMOUNT_WITHOUT_VAT,',
'    :P29_DUE_AMOUNT_WITH_VAT_WORDS,',
'    :P29_CURRENT_VALUATION_AMOUNT2,',
'    :P29_PERIOD2,',
'    :P29_DEDUCTIONS2,',
'    :P29_SCOPE_OF_WORK2,',
'    :P29_REMARK2,',
'    :P29_APPROVAL_STATUS2',
'    ,:P29_CREATED_BY_1',
'      ,:P29_CREATED_ON_1',
'      ,:P29_UPDATED_BY_1',
'      ,:P29_UPDATED_ON_1',
'from cwip_payment_recommendation cpr, cwip_contract c',
'where cpr.payment_recommendation_id = :P29_PAYMENT_RECOMMENDATION_ID',
