...
,p_name=>'Receiving  Data / Table Mapping'
,p_alias=>'RECEIVING-DATA-TABLE-MAPPING'
,p_step_title=>'Receiving  Data / Table Mapping'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100429321069617908)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100430042363617908)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100430325649617908)
,p_plug_name=>'Receiving  Data / Table Mapping'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100431562408617909)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(100430325649617908)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100431290964617909)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100430720514617909)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(100432313021617909)
,p_branch_action=>'f?p=&APP_ID.:52:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(100431562408617909)
...
'                                      where name = ''Receiving Load'' and application_id = apex_application.g_flow_id )',
'                            loop',
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(100432734244617909)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100432031539617909)
...
,p_process_when_button_id=>wwv_flow_api.id(100431562408617909)
);
