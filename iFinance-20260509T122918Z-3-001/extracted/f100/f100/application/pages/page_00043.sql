...
,p_last_upd_yyyymmddhh24miss=>'20220317102135'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100265326949075437)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100266004972075437)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100266378473075437)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100267575173075438)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(100266378473075437)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100267283800075438)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100266798025075437)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(100268303417075438)
,p_branch_action=>'f?p=&APP_ID.:44:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(100267575173075438)
...
'                                      where name = ''Vendor Bank Accounts Upload'' and application_id = apex_application.g_flow_id )',
'                            loop',
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(100268762238075438)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100268058487075438)
...
,p_process_when_button_id=>wwv_flow_api.id(100267575173075438)
);
