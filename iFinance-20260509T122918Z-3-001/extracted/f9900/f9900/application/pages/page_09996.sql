...
,p_last_upd_yyyymmddhh24miss=>'20210930100815'
);
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(7950468533144839)
,p_name=>'Change My Password'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(8345167068023642)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(7950579134144840)
,p_event_id=>wwv_flow_api.id(7950468533144839)
,p_event_result=>'TRUE'
...
'end;'))
,p_attribute_02=>'P9996_NEW_PASSWORD'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
