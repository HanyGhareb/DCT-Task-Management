...
,p_last_upd_yyyymmddhh24miss=>'20211003152951'
);
...
'       UPDATED_BY',
'  from MENUS_EXT m',
'  where m.ID in (  select mr.menu_id ',
'                        from MENU_ROLES_EXT  mr',
'                        where mr.menu_id = m.ID',
'                        and mr.role_id in (SELECT role_id',
'                                            FROM cwip_team',
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(40512194634056828)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(40512057835056827)
