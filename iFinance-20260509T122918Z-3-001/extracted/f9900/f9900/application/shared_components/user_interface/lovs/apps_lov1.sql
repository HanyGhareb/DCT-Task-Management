prompt --application/shared_components/user_interface/lovs/apps_lov1
begin
--   Manifest
--     APPS LOV1
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(40056481978842660)
,p_lov_name=>'APPS LOV1'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select APPLICATION_NAME , APPLICATION_ID ,  HOME_LINK ,LOGIN_URL	 ',
