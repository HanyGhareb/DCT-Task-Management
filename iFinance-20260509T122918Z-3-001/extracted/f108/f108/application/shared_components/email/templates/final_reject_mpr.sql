prompt --application/shared_components/email/templates/final_reject_mpr
begin
--   Manifest
--     REPORT LAYOUT: Final Reject MPR
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(22637749981821060)
,p_name=>'Final Reject MPR'
,p_static_id=>'FINAL_REJECT_MPR'
,p_subject=>'Your Manual PR #REQUEST_NUMBER#  has been Rejected'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hi <b><span style="color: #0e6654;"><i>#REQUESTED_PERSON_NAME#,</i></span></b>',
'<br>',
'<br>',
'Please note that your Manual PR# <span style="color: #0e6654;"><i><b>#REQUEST_NUMBER#</b></i></span> has been <span style="color:red;"><b>Rejected</b></span>.',
'<br>',
'<br>',
'',
