prompt --application/shared_components/email/templates/delegate_mpr
begin
--   Manifest
--     REPORT LAYOUT: DELEGATE MPR
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(23363812650720792)
,p_name=>'DELEGATE MPR'
,p_static_id=>'DELEGATE_MPR'
...
'<br>',
'<br>',
'Please note that <b><span style="color: #0e6654;"><i>#DELEGATED_FROM#,</i></span></b> delegate the Manual PR# <span style="color: #0e6654;"><i><b>#REQUEST_NUMBER#</b></i></span> to you.',
'',
