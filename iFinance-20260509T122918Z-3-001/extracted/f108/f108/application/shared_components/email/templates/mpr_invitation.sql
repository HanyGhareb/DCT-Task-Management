prompt --application/shared_components/email/templates/mpr_invitation
begin
--   Manifest
--     REPORT LAYOUT: MPR  Invitation
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(22638228438834367)
,p_name=>'MPR  Invitation'
,p_static_id=>'MPR_INVITATION'
,p_subject=>'i-Finance: Manual PR Management Invitation'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hi <b><span style="color: #0e6654;"><i><b>#TITLE# #EMP_NAME#,</b></i></span></b>',
'<br>',
'<br>',
'you are invited to use <span style="color: #0e6654;"><i><b>Manual PR Management module </b></i></span>in <span style="color: #0e6654;"><i><b>i-Finance System </b></i></span> where you can easly create, submit and follow-up your Manual PR requests. ',
'<br>',
'<br>',
'',
...
'  <li><a href="https://ifinance.dct.gov.ae:8004/dct/prod/r/files/static/v19/Create%20New%20MPR.pdf#">How to create new Manual PR</a></li>',
'</ul>',
'<br>',
'<br>',
