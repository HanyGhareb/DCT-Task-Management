prompt --application/shared_components/email/templates/fyi_submit_mpr
begin
--   Manifest
--     REPORT LAYOUT: FYI Submit MPR
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(22662230085715460)
,p_name=>'FYI Submit MPR'
,p_static_id=>'FYI_SUBMIT_MPR'
,p_subject=>'FYI - Manual PR #REQUEST_NUMBER# for  #REQUESTED_PERSON_NAME#, Amount #REQUESTED_AMOUNT# #CURRENCY#  has been Submitted'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hi <b><span style="color: #0e6654;"><i>#FYI_EMP_NAME#,</i></span></b>',
'<br>',
'<br>',
'Please note that Manual PR# <span style="color: #0e6654;"><i><b>#REQUEST_NUMBER#</b></i></span> for employee: <span style="color: #0e6654;"><i><b>#REQUESTED_PERSON_NAME#</b></i></span> has been <span style="color: #0e6654;"><i><b>Submitted</b></i></s'
||'pan>.',
'<br>',
'<br>',
