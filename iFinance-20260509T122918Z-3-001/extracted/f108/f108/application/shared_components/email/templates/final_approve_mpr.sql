prompt --application/shared_components/email/templates/final_approve_mpr
begin
--   Manifest
--     REPORT LAYOUT: Final Approve MPR
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(22637590964812531)
,p_name=>'Final Approve MPR'
,p_static_id=>'FINAL_APPROVE_MPR'
,p_subject=>'Your Manual PR #REQUEST_NUMBER# has been Approved'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hi <b><span style="color: #0e6654;"><i>#REQUESTED_PERSON_NAME#,</i></span></b>',
'<br>',
'<br>',
'Please note that your Manual PR# <span style="color: #0e6654;"><i><b>#REQUEST_NUMBER#</b></i></span> has been <span style="color:green;"><b>finally approved</b></span>.',
'',
'',
