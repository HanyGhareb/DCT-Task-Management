prompt --application/shared_components/email/templates/reminder_approve_reject_mpr
begin
--   Manifest
--     REPORT LAYOUT: Reminder Approve Reject MPR
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(22638497320838659)
,p_name=>'Reminder Approve Reject MPR'
,p_static_id=>'REMINDER_APPROVE_REJECT_MPR'
,p_subject=>'Reminder: Action Required: Manual PR# REQUEST_NUMBER for #REQUESTED_PERSON_NAME# , Amount #REQUESTED_AMOUNT#  #CURRENCY#'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<h1 style="background-color:Red; color: white; text-align: center;">Reminder</h1>',
'<br>',
'Hi <b><span style="color: #0e6654;"><i>#APPROVER_EMP_NAME#,</i></span></b>',
'<br>',
'<br>',
'This is a kind reminder for action required for the Manual PR# <span style="color: #0e6654;"><i><b>#REQUEST_NUMBER#</b></i></span> for employee: <span style="color: #0e6654;"><i><b>#REQUESTED_PERSON_NAME#</b></i></span><br>',
'<br>',
'<br>',
...
'<br>',
'<br>',
'For any assistance, please contact <a href="mailto:CSekhar@dctabudhabi.ae">Mr. Chandra Sekhar</a> (Supply Management Department)',
''))
