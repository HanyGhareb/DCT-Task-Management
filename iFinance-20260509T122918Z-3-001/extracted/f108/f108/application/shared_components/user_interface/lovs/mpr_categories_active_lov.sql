prompt --application/shared_components/user_interface/lovs/mpr_categories_active_lov
begin
--   Manifest
--     MPR CATEGORIES ACTIVE  LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(22174804847972244)
,p_lov_name=>'MPR CATEGORIES ACTIVE  LOV'
