...
,p_name=>'Invitation - MPR'
,p_alias=>'INVITATION-MPR'
,p_step_title=>'Invitation - MPR'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'TCA282'
,p_last_upd_yyyymmddhh24miss=>'20230222113808'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(25296771315051780)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(25297380738051780)
,p_plug_name=>'Invitation - MPR'
,p_region_name=>'USERS'
...
,p_prn_page_header=>'Invitation - MPR'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(25297553236051780)
...
,p_owner=>'TCA9051'
,p_internal_uid=>25297553236051780
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22751972485954724)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22752386050954724)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22752721370954724)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22753115068954724)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22753505522954725)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22750775848954723)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22751157809954723)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22751580479954723)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22753934855954725)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22754347113954725)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(25301736792080216)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'227547'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'EMPLOYEE_NUM:TITLE:EMP_NAME:USER_NAME:SUPERVISOR_NUM:EMAIL:ORG_NAME:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(22931580126605328)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(25297380738051780)
,p_button_name=>'Send_Delegate_Mail'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_api.id(19256715332383394)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Send Delegate Mail'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(22756327404954730)
...
,p_button_redirect_url=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.::P11_RESET_PW:N'
,p_icon_css_classes=>'fa-envelope-plus'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(22757344960954731)
,p_name=>'Send'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(22756327404954730)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
,p_display_when_type=>'NEVER'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(22757857124954732)
,p_event_id=>wwv_flow_api.id(22757344960954731)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(22758304368954732)
,p_event_id=>wwv_flow_api.id(22757344960954731)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(22758822493954733)
,p_event_id=>wwv_flow_api.id(22757344960954731)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(22759202670954733)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(22759771285954733)
,p_event_id=>wwv_flow_api.id(22759202670954733)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(22931683864605329)
,p_name=>'Send Delegate Mail'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(22931580126605328)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(22931768456605330)
,p_event_id=>wwv_flow_api.id(22931683864605329)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
