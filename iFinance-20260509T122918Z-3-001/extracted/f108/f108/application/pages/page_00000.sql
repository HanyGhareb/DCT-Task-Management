...
,p_last_upd_yyyymmddhh24miss=>'20210318094636'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(20288827805339523)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20288913996339524)
,p_event_id=>wwv_flow_api.id(20288827805339523)
,p_event_result=>'TRUE'
,p_action_sequence=>5
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20289041547339525)
,p_event_id=>wwv_flow_api.id(20288827805339523)
,p_event_result=>'TRUE'
