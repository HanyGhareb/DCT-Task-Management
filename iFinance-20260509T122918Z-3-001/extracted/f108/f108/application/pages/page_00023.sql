...
,p_last_upd_yyyymmddhh24miss=>'20211121063155'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3844440953265156)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3843783965265156)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3843518796265156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3842263709265155)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(3843518796265156)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3842522179265156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3843067179265156)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3841486660265155)
,p_branch_action=>'f?p=&APP_ID.:24:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3842263709265155)
...
'                                      where name = ''Pending POs Upload'' and application_id = apex_application.g_flow_id )',
'                            loop',
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3841051156265155)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3841742591265155)
...
,p_process_when_button_id=>wwv_flow_api.id(3842263709265155)
);
