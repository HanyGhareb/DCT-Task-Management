...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23127416015113752)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23127369218113752)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(23127416015113752)
,p_button_name=>'CLOSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(23127531128113752)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(23127369218113752)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(23137661729113727)
,p_event_id=>wwv_flow_api.id(23127531128113752)
,p_event_result=>'TRUE'
