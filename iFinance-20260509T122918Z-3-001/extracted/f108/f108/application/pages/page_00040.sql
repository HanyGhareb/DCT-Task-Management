...
,p_alias=>'MANUAL-PR-ACTION'
,p_page_mode=>'MODAL'
,p_step_title=>'Manual PR Action'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'TCA9051'
,p_last_upd_yyyymmddhh24miss=>'20230216114335'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(98952350781444993)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(177905465869236052)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(98675900234848735)
,p_plug_name=>'Select Buyer'
,p_parent_plug_id=>wwv_flow_api.id(177905465869236052)
...
,p_plug_display_when_condition=>':IS_SOUCEING_MANAGER	= 1 and :P40_ACTION = ''Approve'''
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(98675924384848736)
,p_max_row_count=>'1000000'
,p_show_search_bar=>'N'
,p_report_list_mode=>'TABS'
,p_show_detail_link=>'N'
,p_owner=>'TCA9051'
,p_internal_uid=>301842840453281509
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(51915156265446405)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(51914746449446404)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(51914341296446404)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(51913970916446404)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(51913614833446404)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(51886752166164414)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1512802'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'SELECTED:PHOTO:FULL_NAME_EN:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(51912451664446403)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(98952350781444993)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(51912086930446403)
...
,p_button_condition=>'P40_ACTION'
,p_button_condition2=>'Approve'
,p_button_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_icon_css_classes=>'fa-thumbs-o-up'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(51911659836446395)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(51912830696446403)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(51911136217446395)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(51907185779446390)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55044195550168332)
,p_name=>'P40_STEP_NO'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(177905465869236052)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(51918281384446407)
,p_name=>'P40_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(177905465869236052)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(51917871174446407)
,p_name=>'P40_MPR_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(177905465869236052)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(51917461710446406)
,p_name=>'P40_ACTION'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(177905465869236052)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(51917108894446406)
,p_name=>'P40_ACTION_REQUIRED'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(177905465869236052)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(51916664830446406)
,p_name=>'P40_FROM_PERSON_ID'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(177905465869236052)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(51916278327446406)
,p_name=>'P40_TO_PERSON_ID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(177905465869236052)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(51915880204446406)
,p_name=>'P40_COMMENT'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(177905465869236052)
,p_prompt=>'Comment'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(55043825966168329)
,p_computation_sequence=>10
,p_computation_item=>'P40_STEP_NO'
...
'where ID = :P40_ID'))
,p_computation_error_message=>'Step Can not found'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(55044025685168331)
,p_name=>'Close'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(51912451664446403)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(55043927361168330)
,p_event_id=>wwv_flow_api.id(55044025685168331)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(51940905328553769)
,p_name=>'New'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(51912451664446403)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(51940780801553768)
,p_event_id=>wwv_flow_api.id(51940905328553769)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CLOSE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(51910722709446392)
...
'                             MPR_WORKFLOW2.INSERT_BUYER(l_to_person_id , :P40_STEP_NO + 1 , :P40_MPR_ID , ''Pending'');',
'                             END LOOP;',
'                             MPR_WORKFLOW2.Approve_forward(:P40_MPR_ID,:PERSON_ID,:P40_COMMENT,''S'');',
'               End if;',
'     else',
'          MPR_WORKFLOW2.approve(:P40_MPR_ID,:PERSON_ID,:P40_COMMENT,''S'');',
' End if;',
' End;'))
,p_process_error_message=>'Error while approve, Please contact system admin'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(51912086930446403)
,p_process_success_message=>'Approved Successfully.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(51910366830446391)
...
'BEGIN',
'',
'IF :P40_COMMENT is null THEN',
'                    apex_error.add_error(p_message => ''Please enter your Justification! '',',
'                                        p_display_location => apex_error.c_inline_with_field_and_notif);',
'else',
'    MPR_WORKFLOW2.REJECT(:P40_MPR_ID,:PERSON_ID, :P40_COMMENT , ''S'');',
' End if;',
'End;'))
,p_process_error_message=>'Error while Reject, Please contact system admin'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(51911659836446395)
,p_process_success_message=>'Rejected.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(51909926271446391)
...
'BEGIN',
'',
'IF :P40_TO_PERSON_ID is null THEN',
'                    apex_error.add_error(p_message => ''Please select the delegated person.'',',
'                                        p_display_location => apex_error.c_inline_with_field_and_notif);',
'else',
'    MPR_WORKFLOW2.DELEGATE(:P40_MPR_ID,:PERSON_ID, :P40_TO_PERSON_ID, :P40_COMMENT , ''S'');',
' End if;',
'End;'))
,p_process_error_message=>'error while Delegated, Please contact system admin'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(51912830696446403)
,p_process_success_message=>'Delegated'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(51909585440446391)
...
'                                        p_display_location => apex_error.c_inline_with_field_and_notif);',
'else',
'    MPR_WORKFLOW2.RETURN(:P40_MPR_ID, :PERSON_ID, :P40_COMMENT, ''S'');',
' End if;',
'End;'))
,p_process_error_message=>'Not Returned, Contact system admin.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(51911136217446395)
