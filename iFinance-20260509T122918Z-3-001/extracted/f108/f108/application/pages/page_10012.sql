...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23127622904113752)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23127798057113752)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23127958671113752)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(23127798057113752)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23127839960113752)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23139534512113725)
,p_name=>'P10012_FEEDBACK_ATTACHMENTS_YN'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(23127622904113752)
,p_item_default=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(23128073154113752)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(23127958671113752)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(23140390653113725)
,p_event_id=>wwv_flow_api.id(23128073154113752)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23140895534113724)
...
,p_process_when_button_id=>wwv_flow_api.id(23127839960113752)
,p_process_success_message=>'Feedback settings updated.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23141226667113724)
