prompt --application/shared_components/user_interface/lovs/tca_decision_options_lov
begin
--   Manifest
--     TCA DECISION OPTIONS LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(395325957853228)
,p_lov_name=>'TCA DECISION OPTIONS LOV'
