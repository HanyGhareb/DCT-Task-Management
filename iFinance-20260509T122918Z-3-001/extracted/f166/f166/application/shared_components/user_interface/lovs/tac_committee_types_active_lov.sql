prompt --application/shared_components/user_interface/lovs/tac_committee_types_active_lov
begin
--   Manifest
--     TAC COMMITTEE TYPES ACTIVE LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(26504590426049731)
,p_lov_name=>'TAC COMMITTEE TYPES ACTIVE LOV'
