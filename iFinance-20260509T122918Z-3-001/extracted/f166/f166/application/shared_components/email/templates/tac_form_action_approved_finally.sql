prompt --application/shared_components/email/templates/tac_form_action_approved_finally
begin
--   Manifest
--     REPORT LAYOUT: TAC Form Action Approved Finally
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(69823903041885687)
,p_name=>'TAC Form Action Approved Finally'
,p_static_id=>'TAC_FORM_ACTION_APPROVED_FINALLY'
,p_subject=>'FYI - #PURPOSE# Request,Amount: #ESTIMATED_BUDGET# for #REQUESTOR_NAME# Finally Approved.'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Dear <strong><span style="color: #003366;">#APPROVER_TITLE# #APPROVER_NAME#</span></strong>, <br /><br />Below #PURPOSE# Request has been finally <span style="color: #00ff00;"><em>Approved</em></span></p>',
