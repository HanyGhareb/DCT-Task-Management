prompt --application/shared_components/email/templates/ss_delegate_from
begin
--   Manifest
--     REPORT LAYOUT: SS Delegate from
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(69401095176563633)
,p_name=>'SS Delegate from'
,p_static_id=>'SS_DELEGATE_FROM'
,p_subject=>'FYI- you delegate Single Source Req #REQUEST_NUMBER#,Amount: #ESTIMATED_BUDGET# for #REQUESTOR#'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Dear <span style="color: #ff0000;"><span style="color: #000000;"><strong>#ACTION_DONE_BY#</strong></span></span>, <br /><br />you have delegate below Single Source request to <strong><span style="color: #003366;">#APPROVER_TITLE# #APPROVER_NAME#</'
||'span></strong><span style="color: #ff0000;"><span style="color: #000000;">&nbsp;</span></span></p>',
...
'<h5><i>MIS Team</i>,</h5>',
'</div>'))
,p_comment=>'Used to send Email to the person who delegate Single Source request'
);
