prompt --application/shared_components/email/templates/single_source_action_rejected_finally
begin
--   Manifest
--     REPORT LAYOUT: Single Source Action Rejected Finally
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(66893683757373195)
,p_name=>'Single Source Action Rejected Finally'
,p_static_id=>'SINGLE_SOURCE_ACTION_REJECTED_FINALLY'
,p_subject=>'FYI- Single Source Req #REQUEST_NUMBER#,Amount: #ESTIMATED_BUDGET# form #REQUESTOR#  Rejected'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Dear <strong><span style="color: #003366;">#APPROVER_TITLE# #APPROVER_NAME#</span></strong>, <br /><br />Below Single Source request has been <strong><span style="color: #ff0000;"><em>Rejected </em></span></strong><span style="color: #ff0000;"><sp'
||'an style="color: #000000;">by <strong>#ACTION_DONE_BY#</strong></span></span></p>',
'<p><span style="color: #ff0000;"><em>#COMMENTS#</em></span></p>',
'<table style="height: 592px; width: 120%; border-collapse: collapse;" border="0">',
'<tbody>',
'<tr style="height: 18px;">',
'<td style="width: 45.3857%; height: 18px; background-color: #00008b;" colspan="3"><span style="color: #ffffff;"><strong><em>FYI- Single Source Approval</em></strong></span></td>',
'</tr>',
'<tr style="height: 18px;">',
...
'</tr>',
'<tr style="height: 18px;">',
'<td style="width: 10.5372%; font-size: 10px; height: 18px;"><em>Estimated Budget:</em></td>',
'<td style="width: 34.1599%; font-size: 10px; height: 18px;">#ESTIMATED_BUDGET#</td>',
'<td style="width: 0.688705%; height: 18px;">&nbsp;</td>',
'</tr>',
'<tr style="height: 18px;">',
...
'</tr>',
'<tr style="height: 18px;">',
'<td style="width: 10.5372%; font-size: 10px; height: 18px;"><em>Cost Center:</em></td>',
'<td style="width: 34.1599%; font-size: 10px; height: 18px;">&nbsp;#COST_CENTER#</td>',
'<td style="width: 0.688705%; height: 18px;">&nbsp;</td>',
'</tr>',
'<tr style="height: 18px;">',
