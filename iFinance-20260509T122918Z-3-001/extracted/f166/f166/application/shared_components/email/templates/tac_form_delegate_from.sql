prompt --application/shared_components/email/templates/tac_form_delegate_from
begin
--   Manifest
--     REPORT LAYOUT: TAC Form Delegate from
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(69824479553921800)
,p_name=>'TAC Form Delegate from'
,p_static_id=>'TAC_FORM_DELEGATE_FROM'
,p_subject=>'FYI- you delegate #PURPOSE# Request, Amount: #ESTIMATED_BUDGET# for #REQUESTOR_NAME#'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Dear <span style="color: #ff0000;"><span style="color: #000000;"><strong>#ACTION_DONE_BY#</strong></span></span>, <br /><br />you have delegate below #PURPOSE# Request to <strong><span style="color: #003366;">#APPROVER_TITLE# #APPROVER_NAME#</span'
||'></strong><span style="color: #ff0000;"><span style="color: #000000;">&nbsp;</span></span></p>',
