...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24857580709318744)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(24858635815318744)
,p_name=>'Manage User Access'
...
,p_owner=>'TCA9051'
,p_internal_uid=>24858635815318744
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24858772184318739)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24859159903318737)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24859518176318736)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(24860247224318735)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'248603'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24861132138318735)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(24857580709318744)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24861528304318734)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24861962244318734)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(24857653150318744)
,p_name=>'Refresh on Dialog Close'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(24857580709318744)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(24862596867318734)
,p_event_id=>wwv_flow_api.id(24857653150318744)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(24857580709318744)
);
