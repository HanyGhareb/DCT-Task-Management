prompt --application/pages/page_10085
begin
--   Manifest
--     PAGE: 10085
--   Manifest End
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21535440614647297)
...
'        and time_stamp >= sysdate - ( 1/24/60/60 * :P10085_TIMEFRAME )',
'        and userid is not null',
'    group by userid_lc) x'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P10085_TIMEFRAME'
,p_plug_display_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_plug_display_when_condition=>'P10085_VIEW_AS'
,p_plug_display_when_cond2=>'REPORT'
,p_prn_page_header=>'Top Users'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(21536889954647298)
,p_name=>'Top Users'
...
,p_owner=>'TCA9051'
,p_internal_uid=>21536889954647298
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21536985449647305)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21537372347647308)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21537733600647311)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21538112688647314)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21538519525647317)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21538951379647320)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21539364453647323)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21539709457647326)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(21540468802647328)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'215405'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21535585658647297)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21535757589647297)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(21535873440647297)
,p_region_id=>wwv_flow_api.id(21535757589647297)
,p_chart_type=>'donut'
,p_height=>'600'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(21544086415647331)
,p_chart_id=>wwv_flow_api.id(21535873440647297)
,p_seq=>10
,p_name=>'Top Users'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21541336242647329)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(21535440614647297)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21535954369647297)
,p_name=>'P10085_VIEW_AS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(21535585658647297)
...
,p_lov=>'.'||wwv_flow_api.id(10409072446598124)||'.'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21536148211647297)
,p_name=>'P10085_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(21535585658647297)
,p_item_default=>'900'
,p_prompt=>'Timeframe'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(21535603653647297)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10085_TIMEFRAME'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(21542628670647330)
,p_event_id=>wwv_flow_api.id(21535603653647297)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(21535440614647297)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(21544918914647331)
,p_event_id=>wwv_flow_api.id(21535603653647297)
,p_event_result=>'TRUE'
