...
,p_last_upd_yyyymmddhh24miss=>'20210904110032'
);
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31545309031738529)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31546128164738528)
...
,p_is_default=>'Y'
,p_display_rows=>25
,p_report_columns=>'CONTRACT_NUMBER:VENDOR_NAME:VENDOR_SITE_CODE:INITIAL_CONTRACT_AMOUNT:CONTRACT_AMOUNT:BILLED_AMOUNT:CONTRACT_VARIATION_AMOUNT:CONTRACT_TYPE:CONTRACT_MODE:BUYER_NAME:START_DATE:'
