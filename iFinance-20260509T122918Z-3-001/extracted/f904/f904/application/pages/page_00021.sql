...
,p_last_upd_yyyymmddhh24miss=>'20210903191009'
);
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22504214381061619)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22504494374061621)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(33326525842261467)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(33326942864261467)
,p_report_id=>wwv_flow_api.id(22540078165090509)
,p_name=>'Rejected'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_redirect_url=>'f?p=&APP_ID.:22:&SESSION.::&DEBUG.:22:P22_PROJECT_NUMBER:&P21_PROJECT_NUMBER.'
