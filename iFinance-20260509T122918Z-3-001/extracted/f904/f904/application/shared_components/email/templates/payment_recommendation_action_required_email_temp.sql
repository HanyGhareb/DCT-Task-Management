...
,p_subject=>'Action Required - Payment Recommendation #PAYMENT_NUMBER# for #CONTRACTING_PARTY#'
...
'<table border="0" align="center">                      ',
'	<tbody><tr>',
'				<td style="padding:16px 24px;border-radius:4px;min-width:200px;" bgcolor="red" align="center">',
'                          <a rel="nofollow" target="_blank" href="#EXPRESS_LINK#" style="font-size:16px;line-height:16px;font-weight:700;color:#FCFBFA;text-decoration:none;display:inline-block;padding:16px 24px;"> OTP Approve / Reject </a>           '
||'             ',
'				</td>                      ',
'			</tr>                    ',
'	</tbody>',
