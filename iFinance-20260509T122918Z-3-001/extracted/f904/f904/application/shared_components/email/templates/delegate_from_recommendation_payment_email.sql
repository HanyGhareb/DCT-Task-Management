prompt --application/shared_components/email/templates/delegate_from_recommendation_payment_email
begin
--   Manifest
--     REPORT LAYOUT: Delegate From Recommendation Payment Email
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(39305661299374653)
,p_name=>'Delegate From Recommendation Payment Email'
,p_static_id=>'DELEGATE_FROM_RECOMMENDATION_PAYMENT_EMAIL'
,p_subject=>'Delegate - Payment Recommendation'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello  <b><span style="color: #0e6654;"><i>#APPROVER_TITL# #APPROVER_EMP_NAME#,</i></span></b>',
'<br>',
'<br>',
'you have delegate below Recommendation Payment Request to <span style="color: #0e6654;"><i><b>#DELEGATE_TO_EMP_TITLE# #DELEGATE_TO_EMP_NAME# </b></i></span>  for his/her action.',
'<br>',
'<br>',
'<br>',
'<br>',
