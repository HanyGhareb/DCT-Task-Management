prompt --application/shared_components/email/templates/payment_recommendation_more_information_email
begin
--   Manifest
--     REPORT LAYOUT: Payment Recommendation More Information Email
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(39224386593179059)
,p_name=>'Payment Recommendation More Information Email'
,p_static_id=>'PAYMENT_RECOMMENDATION_MORE_INFORMATION_EMAIL'
,p_subject=>'More Info- Payment Recommendation #PAYMENT_NUMBER# for #CONTRACTING_PARTY#  Required.'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Dear #APPROVER_TITLE# #APPROVER_NAME#,',
'<br>',
'<br>',
'Please note that more information required by <span style="color: #529FEC;"><i><b>#EMP_TITLE# #EMP_NAME# </b></i></span>as below: ',
'<br>',
