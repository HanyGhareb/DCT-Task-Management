prompt --application/shared_components/email/templates/payment_recommendation_final_approve_email
begin
--   Manifest
--     REPORT LAYOUT: Payment Recommendation Final Approve Email
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(39207713769522208)
,p_name=>'Payment Recommendation Final Approve Email'
,p_static_id=>'PAYMENT_RECOMMENDATION_FINAL_APPROVE_EMAIL'
,p_subject=>'FYI- Payment Recommendation #PAYMENT_NUMBER# for #CONTRACTING_PARTY# has been Approved.'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Dear #APPROVER_TITLE# #APPROVER_NAME#,',
'<br>',
'<br>',
'below payment recommendation application has been <span style="color: green;"><i><b>Approved.</b></i></span> Finance Team are procee the payment.',
'<br>',
'Comment: #COMMENT#',
'<br>',
'<br>',
