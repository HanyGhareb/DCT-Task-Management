...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(12585531636422994)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(12586019333428345)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(12586437293428346)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(12586896609428346)
