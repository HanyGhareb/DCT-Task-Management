...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'ifinance Template')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'IFINANCE-TEMPLATE')
...
,p_logo_text=>'<cite>i-<b>finance - Template</b></cite>'
...
,p_security_scheme=>wwv_flow_api.id(99846315743410815)
,p_rejoin_existing_sessions=>'N'
,p_csv_encoding=>'Y'
,p_auto_time_zone=>'N'
,p_substitution_string_01=>'APP_NAME'
,p_substitution_value_01=>'ifinance Template'
,p_last_updated_by=>'TCA9051'
,p_last_upd_yyyymmddhh24miss=>'20220316190412'
