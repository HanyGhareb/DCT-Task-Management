prompt --application/shared_components/user_interface/lovs/fl_technology_required
begin
--   Manifest
--     FL_TECHNOLOGY_REQUIRED
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(179821113238616650)
,p_lov_name=>'FL_TECHNOLOGY_REQUIRED'
