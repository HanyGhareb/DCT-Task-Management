prompt --application/shared_components/user_interface/lovs/fl_payment_terms_lov
begin
--   Manifest
--     FL PAYMENT TERMS LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(36994942600162123)
,p_lov_name=>'FL PAYMENT TERMS LOV'
