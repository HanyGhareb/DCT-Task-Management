prompt --application/shared_components/user_interface/lovs/fl_agreement_types_lov
begin
--   Manifest
--     FL AGREEMENT TYPES LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(36994536682193431)
,p_lov_name=>'FL AGREEMENT TYPES LOV'
