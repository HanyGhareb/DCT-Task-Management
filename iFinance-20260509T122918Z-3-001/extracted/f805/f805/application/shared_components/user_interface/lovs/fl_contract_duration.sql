prompt --application/shared_components/user_interface/lovs/fl_contract_duration
begin
--   Manifest
--     FL_CONTRACT_DURATION
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(179786492184534593)
,p_lov_name=>'FL_CONTRACT_DURATION'
