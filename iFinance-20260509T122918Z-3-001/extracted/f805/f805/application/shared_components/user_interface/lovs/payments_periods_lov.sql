prompt --application/shared_components/user_interface/lovs/payments_periods_lov
begin
--   Manifest
--     PAYMENTS PERIODS LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(36993661737219010)
,p_lov_name=>'PAYMENTS PERIODS LOV'
