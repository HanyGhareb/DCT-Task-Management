prompt --application/shared_components/user_interface/lovs/freelancers_activities_lov
begin
--   Manifest
--     FREELANCERS ACTIVITIES LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(36343483546537111)
,p_lov_name=>'FREELANCERS ACTIVITIES LOV'
