prompt --application/shared_components/user_interface/lovs/dct_person_types_active_lov
begin
--   Manifest
--     DCT PERSON TYPES - ACTIVE LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(36633561280171372)
,p_lov_name=>'DCT PERSON TYPES - ACTIVE LOV'
