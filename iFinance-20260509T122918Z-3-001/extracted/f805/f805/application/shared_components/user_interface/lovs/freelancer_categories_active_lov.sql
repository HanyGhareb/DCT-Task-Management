prompt --application/shared_components/user_interface/lovs/freelancer_categories_active_lov
begin
--   Manifest
--     FREELANCER CATEGORIES- ACTIVE LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(36634965454120718)
,p_lov_name=>'FREELANCER CATEGORIES- ACTIVE LOV'
