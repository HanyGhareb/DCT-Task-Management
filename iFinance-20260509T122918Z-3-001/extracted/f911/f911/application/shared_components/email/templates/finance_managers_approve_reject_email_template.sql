prompt --application/shared_components/email/templates/finance_managers_approve_reject_email_template
begin
--   Manifest
--     REPORT LAYOUT: Finance Managers Approve Reject Email Template
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(38613004491586640)
,p_name=>'Finance Managers Approve Reject Email Template'
,p_static_id=>'FINANCE_MANAGERS_APPROVE_REJECT_EMAIL_TEMPLATE'
,p_subject=>'Action Required: Credit Card request for #EMP_NAME# , Amount #AMOUNT# AED'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello  <b><span style="color: #0e6654;"><i>#APPROVER_TITL# #APPROVER_EMP_NAME#,</i></span></b>',
'<br>',
'<br>',
'your kind attention is required for Credit card Request for employee: <span style="color: #0e6654;"><i><b>#EMP_TITLE# #EMP_NAME#</b></i></span> for <span style="color: #0e6654;"><i><b>#AMOUNT#</b></i></span> AED.',
'<br>',
'<br>',
'',
...
'<br>',
'<span style="color: red; font-size:14px"> Comment: </span> ',
