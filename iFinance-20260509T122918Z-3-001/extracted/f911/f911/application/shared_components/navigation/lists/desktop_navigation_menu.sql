...
'where entity_id =  52    -- 47 for Undersecretary Role',
'and status = ''A''',
...
,p_list_item_disp_cond_type=>'PLSQL_EXPRESSION'
,p_list_item_disp_condition=>':PERSON_ID in (680461, 127431)'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(116715109113255002)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(116700661079993094)
,p_list_item_display_sequence=>110
,p_list_item_link_text=>'Gift Cards Categories'
