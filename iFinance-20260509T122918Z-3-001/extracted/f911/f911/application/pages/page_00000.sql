...
,p_last_upd_yyyymmddhh24miss=>'20220424110712'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(33464204351009041)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(33464322402009042)
,p_event_id=>wwv_flow_api.id(33464204351009041)
,p_event_result=>'TRUE'
,p_action_sequence=>5
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(33464487728009043)
,p_event_id=>wwv_flow_api.id(33464204351009041)
,p_event_result=>'TRUE'
...
' , created_on',
'FROM',
'    credit_card_requests_notifications_v',
'UNION All    ',
'SELECT',
'    note_icon,',
'    note_icon_color,',
...
' created_on',
'FROM',
'    gift_cards_requests_notifications_v)',
