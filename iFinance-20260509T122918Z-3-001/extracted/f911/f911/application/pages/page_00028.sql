...
,p_name=>'Gift Card Request Lines'
,p_alias=>'GIFT-CARD-REQUEST-LINES'
,p_step_title=>'Gift Card Request Lines'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'TCA9051'
,p_last_upd_yyyymmddhh24miss=>'20220410134016'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(116736808445270515)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(116736244337270514)
,p_plug_name=>'hidden'
