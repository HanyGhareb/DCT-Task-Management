...
,p_last_upd_yyyymmddhh24miss=>'20210828125031'
);
...
,p_query_type=>'TABLE'
,p_query_table=>'CREDIT_CARDS_REQUESTS_V'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38670636788271457)
,p_db_column_name=>'Emirates ID'
,p_display_order=>35
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'FULL_NAME_EN:EMPLOYEE_NUMBER:DEPARTMENT_NAME:SECTOR:AMOUNT:DCT_APPROVAL_STATUS:BANK_APPROVAL_STATUS'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(77638100442914788)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(77637737360914788)
,p_report_id=>wwv_flow_api.id(38675460627271096)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(77637301005914788)
,p_report_id=>wwv_flow_api.id(38675460627271096)
,p_name=>'DOA Approved'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(77636960396914788)
,p_report_id=>wwv_flow_api.id(38675460627271096)
,p_name=>'DOA Rejected'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
