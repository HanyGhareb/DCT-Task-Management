...
,p_last_upd_yyyymmddhh24miss=>'20230616065414'
);
...
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_redirect_url=>'https://ifinance.dct.gov.ae:9603/xmlpserver'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'l_count number;',
'begin',
...
,p_item_template_options=>'#DEFAULT#'
,p_is_persistent=>'N'
,p_help_text=>'(maximum 19 characters including spaces)'
,p_inline_help_text=>'(maximum 19 characters including spaces)'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
