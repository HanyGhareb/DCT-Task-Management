...
,p_last_upd_yyyymmddhh24miss=>'20230704060215'
);
...
,p_plug_display_when_condition=>':TREASURY_ADMIN_YN = ''Y'' or :IS_CREDIT_CARD_VIEWER_YN = ''Y'''
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(2029675250875538)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PHOTO:HOLDER_PERSON_ID:EMPLOYEE_NUM:EMAIL:CREDIT_LIMIT:SECTOR_ID:DEPARTMENT_ID:STATUS:INCREASE_LIMIT2:DECREASE_LIMIT2:CLOSE_CARD2:REPLACEMENT:'
,p_sum_columns_on_break=>'CREDIT_LIMIT'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(60942905527503668)
,p_application_user=>'TCA9051'
,p_name=>'Limit By Sector'
,p_report_seq=>10
,p_report_type=>'GROUP_BY'
,p_report_columns=>'PHOTO:HOLDER_PERSON_ID:EXPIRED_DATE:EMAIL:CREDIT_LIMIT:DEPARTMENT_ID:SECTOR_ID:INCREASE_LIMIT:DECREASE_LIMIT:CLOSE_CARD'
,p_sum_columns_on_break=>'CREDIT_LIMIT'
);
wwv_flow_api.create_worksheet_group_by(
 p_id=>wwv_flow_api.id(60942570848496109)
,p_report_id=>wwv_flow_api.id(60942905527503668)
,p_group_by_columns=>'SECTOR_ID'
,p_function_01=>'SUM'
,p_function_column_01=>'CREDIT_LIMIT'
,p_function_db_column_name_01=>'APXWS_GBFC_01'
,p_function_label_01=>'Total Limit'
,p_function_format_mask_01=>'999G999G999G999G990D00'
,p_function_sum_01=>'Y'
,p_sort_column_01=>'APXWS_GBFC_01'
,p_sort_direction_01=>'DESC NULLS FIRST'
);
wwv_flow_api.create_page_plug(
...
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
,p_plug_display_when_condition=>':TREASURY_ADMIN_YN = ''Y'' or :PERSON_ID in (310555) or :IS_CREDIT_CARD_VIEWER_YN = ''Y'''
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
'  or CREATOR_PERSON_ID = decode(:IS_CREDIT_CARD_VIEWER_YN,''Y'', CREATOR_PERSON_ID, :PERSON_ID)',
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(76379691745443551)
,p_application_user=>'TCA9181'
,p_name=>'Demo Report '
,p_report_seq=>10
,p_report_columns=>'REQUESTOR_PERSON_ID:DEPARTMENT_ID:COST_CENTER:PURPOSE:REQUESTED_AMOUNT:EMAIL:ADCB_CUSTOMER_YN:DCT_APPROVAL_STATUS:BANK_APPROVAL_STATUS:'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(76379571704443551)
,p_report_id=>wwv_flow_api.id(76379691745443551)
,p_name=>'Finance Approved'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'BANK_APPROVAL_STATUS'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(76379490977443551)
,p_report_id=>wwv_flow_api.id(76379691745443551)
,p_name=>'Finance In-Progress'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(76379390523443551)
,p_report_id=>wwv_flow_api.id(76379691745443551)
,p_name=>'Finance rejected'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(76379273931443551)
,p_report_id=>wwv_flow_api.id(76379691745443551)
,p_name=>'Approved'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(76379160015443551)
,p_report_id=>wwv_flow_api.id(76379691745443551)
,p_name=>'In-Progress'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(76379073212443551)
,p_report_id=>wwv_flow_api.id(76379691745443551)
,p_name=>'Rejected'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(76378940651443551)
,p_report_id=>wwv_flow_api.id(76379691745443551)
,p_name=>'Return'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
