prompt --application/shared_components/email/templates/resubmit_credit_card_request_template
begin
--   Manifest
--     REPORT LAYOUT: Resubmit Credit Card Request Template
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(257037662479429)
,p_name=>'Resubmit Credit Card Request Template'
,p_static_id=>'RESUBMIT_CREDIT_CARD_REQUEST_TEMPLATE'
...
'<br>',
'<br>',
'Kindly note that <span style="color: #0e6654;"><i><b>#EMP_TITLE# #EMP_NAME#</b></i></span> has update his/her credit card request for <span style="color: #0e6654;"><i><b>#AMOUNT#</b></i></span> AED.',
'<br>',
'<br>',
'',
