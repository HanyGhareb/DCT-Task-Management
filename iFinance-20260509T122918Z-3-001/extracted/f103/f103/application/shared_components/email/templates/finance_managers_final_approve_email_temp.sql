prompt --application/shared_components/email/templates/finance_managers_final_approve_email_temp
begin
--   Manifest
--     REPORT LAYOUT: Finance Managers Final Approve Email Temp
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(38612387021773534)
,p_name=>'Finance Managers Final Approve Email Temp'
,p_static_id=>'FINANCE_MANAGERS_FINAL_APPROVE_EMAIL_TEMP'
,p_subject=>'FYI - Credit Card request for #EMP_NAME# , Amount #AMOUNT# AED Approved by Finance managers.'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello  <b><span style="color: #0e6654;"><i>#APPROVER_TITL# #APPROVER_EMP_NAME#,</i></span></b>',
'<br>',
'<br>',
'Kindly note that credit card request for <span style="color: #0e6654;"><i><b>#EMP_TITLE# #EMP_NAME#</b></i></span> for <span style="color: #0e6654;"><i><b>#AMOUNT#</b></i></span> AED has been <span style="color: green;"><i><b>finally approved.</b></i'
||'></span>',
'<br>',
'<br>',
'',
