prompt --application/shared_components/email/templates/delegate_from_credit_card_request_template
begin
--   Manifest
--     REPORT LAYOUT: Delegate From Credit Card Request Template
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(38644372864600500)
,p_name=>'Delegate From Credit Card Request Template'
,p_static_id=>'DELEGATE_FROM_CREDIT_CARD_REQUEST_TEMPLATE'
...
'<br>',
'<br>',
'you have delegate the Credit card Request for employee: <span style="color: #0e6654;"><i><b>#EMP_TITLE# #EMP_NAME#</b></i></span> for <span style="color: #0e6654;"><i><b>#AMOUNT#</b></i></span> AED to <span style="color: #0e6654;"><i><b>#DELEGATE_TO_'
||'EMP_TITLE# #DELEGATE_TO_EMP_NAME# </b></i></span>  for his action.',
'<br>',
'<br>',
