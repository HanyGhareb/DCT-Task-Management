prompt --application/shared_components/email/templates/final_approve_credit_card_request_template
begin
--   Manifest
--     REPORT LAYOUT: Final Approve Credit Card Request Template
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(263771349246743)
,p_name=>'Final Approve Credit Card Request Template'
,p_static_id=>'FINAL_APPROVE_CREDIT_CARD_REQUEST_TEMPLATE'
,p_subject=>'FYI - Credit Card request for #EMP_NAME# , Amount #AMOUNT# AED Finally Approved.'
