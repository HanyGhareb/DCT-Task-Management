prompt --application/shared_components/email/templates/final_reject_credit_card_request_template
begin
--   Manifest
--     REPORT LAYOUT: Final Reject Credit Card Request Template
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(38682320863226681)
,p_name=>'Final Reject Credit Card Request Template'
,p_static_id=>'FINAL_REJECT_CREDIT_CARD_REQUEST_TEMPLATE'
,p_subject=>'FYI - Credit Card request for #EMP_NAME# , Amount #AMOUNT# AED Rejected.'
