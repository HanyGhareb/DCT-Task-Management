prompt --application/shared_components/email/templates/approve_reject_credit_card_request
begin
--   Manifest
--     REPORT LAYOUT: Approve Reject Credit Card Request
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(189858932172852)
,p_name=>'Approve Reject Credit Card Request'
,p_static_id=>'APPROVE_REJECT_CREDIT_CARD_REQUEST'
