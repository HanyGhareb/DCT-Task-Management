...
,p_last_upd_yyyymmddhh24miss=>'20210218045540'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(5069652495045126)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(5069763853045127)
,p_event_id=>wwv_flow_api.id(5069652495045126)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(5069847792045128)
,p_event_id=>wwv_flow_api.id(5069652495045126)
,p_event_result=>'TRUE'
...
'--apex_util.prepare_url( ''f?p=''||:APP_ID||'':2:''||:APP_SESSION||''::NO::P2_USER_NAME:''|| user_name ) EDIT_LINK,',
''''' EDIT_LINK,',
'email EMAIL, ',
'mobile_sms PHONE_NO,',
