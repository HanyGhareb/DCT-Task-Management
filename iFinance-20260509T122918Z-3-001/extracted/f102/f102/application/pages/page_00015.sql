...
,p_name=>'New Organization'
,p_alias=>'NEW-ORGANIZATION'
,p_step_title=>'New Organization'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30252910666827346)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30210011930514748)
,p_plug_name=>'Employees'
,p_parent_plug_id=>wwv_flow_api.id(30253556844827432)
...
'FROM',
'    dct_employees_list2',
'where organization_id = :P15_ORG_ID',
'and current_flag = ''Y'';'))
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(30210098022514749)
...
,p_owner=>'TCA9051'
,p_internal_uid=>30210098022514749
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22202476056863272)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22207236076863278)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22219236801863298)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22225604386863305)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22209251191863284)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22201692208863270)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22202030887863272)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22202820926863273)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22203270538863273)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22203691746863274)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22204011177863274)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22204456701863275)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22204823458863275)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22205210803863276)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22205670118863276)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22206040423863277)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22206499705863277)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22206892872863277)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22207672072863281)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22208043061863282)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22208481200863283)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22208839169863283)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22209649540863284)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22210054768863285)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22210440841863285)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22210870325863286)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22211294028863286)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22211642383863287)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22212016017863288)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22212451819863288)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22212814528863289)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22213258627863289)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22213638079863290)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22214082295863291)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22214452129863291)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22214820272863292)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22215282906863292)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22215636754863293)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22216059356863294)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22216450466863294)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22216867058863295)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22217247739863295)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22217612112863296)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22218011051863296)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22218427919863297)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22218816684863297)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22219687598863298)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22220081536863299)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22220447067863299)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22220888614863300)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22221286539863300)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22221688497863301)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22222075690863301)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22222499255863302)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22222818898863302)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22223276353863303)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22223659435863303)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22224043969863303)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22224407005863304)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22224867952863304)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22225222664863305)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22226026134863306)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22226458572863306)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22226833759863307)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22227206654863307)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22227636439863308)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22228076800863308)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22228474850863309)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22228875005863309)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22229267167863310)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22229629746863311)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22230018252863311)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22230498502863312)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22230825894863312)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(22231210137863313)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(30306208875843604)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'222316'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'EMPLOYEE_NUM:FULL_NAME_EN:EMAIL:USER_NAME:SUPERVISOR_NAME_BLOB::PHOTO'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(22187702753863260)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(30253556844827432)
,p_button_name=>'SAVE'
...
,p_button_condition=>'P15_ORG_ID'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_database_action=>'UPDATE'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(22186935990863260)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(22188145283863260)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(22187364133863260)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(22241901714863320)
,p_branch_name=>'Go To Page &P11_PAGE_FROM'
,p_branch_action=>'f?p=&APP_ID.:&P15_PAGE_FROM.:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22188509667863261)
,p_name=>'P15_PAGE_FROM'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22188919908863261)
,p_name=>'P15_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
,p_source=>'ORG_ID'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22189364893863261)
,p_name=>'P15_ORG_NAME_EN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22189747818863261)
,p_name=>'P15_ORG_NAME_EN_USER'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22190105148863262)
,p_name=>'P15_ORG_NAME_AR'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22190544764863262)
,p_name=>'P15_ORG_NAME_AR_USER'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22190914354863262)
,p_name=>'P15_ORG_LEVEL_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22191345201863262)
,p_name=>'P15_ORG_LEVEL_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22191718474863263)
,p_name=>'P15_PARENT_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22192116979863263)
,p_name=>'P15_PARENT_ORG_ID_USER'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22192597800863263)
,p_name=>'P15_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22192910553863263)
,p_name=>'P15_COST_CENTER_CODE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22193314033863264)
,p_name=>'P15_SHORT_NAME_EN'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22193748421863264)
,p_name=>'P15_MANAGER_EMP_NUM'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22194149619863264)
,p_name=>'P15_FBP_ROLE'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22194502059863264)
,p_name=>'P15_PARTNER_EMP_NUM'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22194946551863264)
,p_name=>'P15_ORG_RATE'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22195397831863265)
,p_name=>'P15_SERVICE_PROVIDER'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22195781855863265)
,p_name=>'P15_ORG_PRIORITY'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22196151888863265)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22196580827863265)
,p_name=>'P15_END_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22196935143863266)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22197327800863266)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22197771417863266)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22198119973863266)
,p_name=>'P15_UPDATED_DATE'
,p_source_data_type=>'TIMESTAMP'
,p_item_sequence=>250
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22198526110863266)
,p_name=>'P15_SHORT_NAME_AR'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>260
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22198918491863267)
,p_name=>'P15_HR_STRUCTURE_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
,p_item_source_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22199382512863267)
,p_name=>'P15_VERSION'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>280
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22199707757863267)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22200106620863267)
,p_name=>'P15_SOURCE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>300
,p_item_plug_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(22241147631863320)
...
,p_associated_item=>wwv_flow_api.id(22197327800863266)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(22241583667863320)
,p_validation_name=>'P15_UPDATED_DATE must be timestamp'
,p_validation_sequence=>270
,p_validation=>'P15_UPDATED_DATE'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_api.id(22198119973863266)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(22200969836863268)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(30253556844827432)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(22200565584863268)
,p_process_sequence=>10
