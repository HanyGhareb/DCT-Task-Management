...
@@application/shared_components/navigation/lists/sshr_list.sql
@@application/shared_components/navigation/lists/p_p_admin_list.sql
@@application/shared_components/navigation/lists/payroll_admin_list.sql
...
@@application/shared_components/navigation/lists/data_load_wizard_progress_outsource_emp_missions_details_upload.sql
...
@@application/shared_components/files/upload_outsource_data_template_csv.sql
@@application/shared_components/files/employees_lookups_xlsx.sql
...
@@application/shared_components/logic/application_items/is_director_yn.sql
@@application/shared_components/logic/application_items/is_ed_yn.sql
@@application/shared_components/logic/application_items/is_fbp_yn.sql
@@application/shared_components/logic/application_items/is_hr_admin.sql
@@application/shared_components/logic/application_items/is_payroll_admin.sql
@@application/shared_components/logic/application_items/is_project_admin_yn.sql
@@application/shared_components/logic/application_items/ou_code.sql
@@application/shared_components/logic/application_items/person_id.sql
@@application/shared_components/logic/application_items/view_all_duty_yn.sql
...
@@application/shared_components/logic/application_computations/is_hr_admin.sql
@@application/shared_components/logic/application_computations/is_fbp_yn.sql
@@application/shared_components/logic/application_computations/ou_code.sql
@@application/shared_components/logic/application_computations/view_all_duty_yn.sql
@@application/shared_components/logic/application_computations/is_director_yn.sql
@@application/shared_components/logic/application_computations/is_ed_yn.sql
@@application/shared_components/logic/application_computations/is_project_admin_yn.sql
...
@@application/shared_components/user_interface/lovs/contract_by_project_page_24.sql
...
@@application/shared_components/user_interface/lovs/employees_details_return_empno_popup.sql
...
@@application/shared_components/user_interface/lovs/payroll_areas_2.sql
@@application/shared_components/user_interface/lovs/payroll_areas_lov.sql
@@application/shared_components/user_interface/lovs/payroll_areas_lov2.sql
@@application/shared_components/user_interface/lovs/per_diem_care_lov.sql
...
@@application/shared_components/email/templates/outsource_company_notify.sql
@@application/shared_components/email/templates/duty_hub_invitation.sql
@@application/shared_components/email/templates/fyi_mission.sql
...
@@application/shared_components/security/authentications/duty_hub_dct.sql
...
@@application/shared_components/data_loading/tables/dct_emp_mission_details_upload.sql
