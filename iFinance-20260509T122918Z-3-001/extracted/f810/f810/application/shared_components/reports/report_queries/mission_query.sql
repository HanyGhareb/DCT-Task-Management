...
,p_report_layout_id=>wwv_flow_api.id(103146718112279953)
,p_format=>'PDF'
,p_output_file_name=>'MISSION_QUERY'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(103147360869281134)
...
'        e.title     ||',
'        '' ''         ||',
'        user_details.get_full_name(request_for)                                           REQUESTOR    ',
...
'        , h.request_status',
'        , h.cost_center || ''-''||user_details.get_cost_center_name(h.cost_center) Cost_Center',
'        , (SELECT d.project_number FROM mission_distributions d where d.request_id = h.request_id and rownum = 1) PROJECT',
'        , (SELECT d.task_number FROM mission_distributions d where d.request_id = h.request_id and rownum = 1) TASK',
'--into  L_MissionType           ',
'FROM  MISSION_HEADER h, employees_v e',
'where h.REQUEST_FOR = e.person_id',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(103147581875281135)
,p_shared_query_id=>wwv_flow_api.id(110391379078711426)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select      SEQ',
'          , (select  SHORT_NAME',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(103147770314281135)
,p_shared_query_id=>wwv_flow_api.id(110391379078711426)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT',
'--    id,',
