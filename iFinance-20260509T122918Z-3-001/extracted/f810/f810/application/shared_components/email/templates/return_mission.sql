prompt --application/shared_components/email/templates/return_mission
begin
--   Manifest
--     REPORT LAYOUT: Return Mission
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(110393296283561633)
,p_name=>'Return Mission'
,p_static_id=>'RETURN_MISSION'
,p_subject=>'#SUBJECT#'
...
'<p>Kindly not that the #REQUEST_TYPE# Request #REQUEST_NO# returned by <strong><span style="color: #008000;">#SENDER_NAME#</span></strong>.</p>',
