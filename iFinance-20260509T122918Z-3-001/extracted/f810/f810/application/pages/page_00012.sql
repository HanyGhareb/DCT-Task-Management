...
,p_last_upd_yyyymmddhh24miss=>'20240208134847'
);
...
'  and (:P12_START_DATE between  nvl(CONFIRMED_START_DATE , start_date) and nvl(CONFIRMED_END_DATE , END_DATE)',
'  OR :P12_END_DATE between  nvl(CONFIRMED_START_DATE , start_date) and nvl(CONFIRMED_END_DATE , END_DATE))',
'  order by START_DATE',
';'))
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(97912060106754153)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(97912211224754154)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'REQUEST_NO:REQUEST_DATE:REQUEST_FOR:START_DATE:END_DATE:JUSTIFICATION:AMOUNT:REQUEST_STATUS:COMPLETE_STATUS::CONFIRMED_START_DATE:CONFIRMED_END_DATE'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7077675109800429)
,p_name=>'P12_ALLOW_MULTI_REQUESTS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(110020617292559145)
,p_use_cache_before_default=>'NO'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select MISSION_UTIL.check_ALLOW_MULTI_REQUESTS(''APDT'')',
'from dual;'))
,p_source_type=>'QUERY'
,p_display_as=>'NATIVE_HIDDEN'
,p_is_persistent=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(81136801701670740)
,p_name=>'P12_CAR_REQUEST_YN'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(110020617292559145)
,p_prompt=>'Per Diem/Car'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(84398684894618537)
,p_name=>'P12_REQUEST_TYPE_DISPLAY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(110020617292559145)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(85706941642488638)
,p_name=>'P12_OU_CODE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(110020617292559145)
,p_item_default=>'OU_CODE'
,p_item_default_type=>'ITEM'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(91874790041376431)
,p_name=>'P12_COST_CENTER'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(110020617292559145)
,p_item_default=>'user_details.get_cost_center(:P12_REQUEST_FOR)'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(91875061740376434)
,p_name=>'P12_CC_H'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(110020617292559145)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(91875212755376435)
,p_name=>'P12_CC_NAME_H'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(110020617292559145)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_api.id(110020617292559145)
,p_prompt=>'Any expenses  covered by other organization ?'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'YES_NO_LOV'
,p_lov=>'.'||wwv_flow_api.id(109820486212935961)||'.'
,p_lov_display_null=>'YES'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'Ticket hotel or per diem provided by other organization'
,p_inline_help_text=>'Ticket hotel or per diem provided by other organization'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_sequence=>250
,p_item_plug_id=>wwv_flow_api.id(110020617292559145)
,p_prompt=>'&P12_REQUEST_TYPE_DISPLAY. Justification'
...
,p_error_message=>'There are Mission/training requests during &P12_START_DATE. and &P12_END_DATE. You can check it in the previous request region.'
...
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'if nvl(:P12_COST_CENTER , user_details.get_cost_center(:P12_REQUEST_FOR)) is null',
'    Then return false;',
'    End if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
...
,p_affected_elements=>'P12_COUNTRY,P12_CITY,P12_END_DATE'
);
wwv_flow_api.create_page_da_action(
...
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P12_COUNTRY,P12_CITY,P12_CAR_REQUEST_YN'
);
wwv_flow_api.create_page_da_action(
...
,p_action=>'NATIVE_CLEAR'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P12_FULL_DAY_YN,P12_EMIRATE,P12_CAR_REQUEST_YN'
);
wwv_flow_api.create_page_da_action(
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(72139405841071958)
...
,p_display_when_cond=>'MISSION_UTIL.MISSION_EXCEPTION_YN(''APDT'') = ''Y'''
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(72139483785071959)
,p_event_id=>wwv_flow_api.id(72139405841071958)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
'where request_status not in (''Cancelled'', ''Rejected'')  --''Approved'' ',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(81514970484368836)
,p_name=>'CAR_REQUEST_YN DA'
,p_event_sequence=>100
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P12_CAR_REQUEST_YN'
,p_condition_element=>'P12_CAR_REQUEST_YN'
,p_triggering_condition_type=>'EQUALS'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(81515105218368837)
,p_event_id=>wwv_flow_api.id(81514970484368836)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P12_END_DATE'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(81515189131368838)
,p_event_id=>wwv_flow_api.id(81514970484368836)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(81515320213368839)
,p_name=>'CAR_REQUEST_YN DA_ Is Per Diem'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(81515327358368840)
,p_event_id=>wwv_flow_api.id(81515320213368839)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(81515444234368841)
,p_event_id=>wwv_flow_api.id(81515320213368839)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(81515989307368846)
,p_name=>'CAR_REQUEST_YN DA_ Is Null'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(81516069747368847)
,p_event_id=>wwv_flow_api.id(81515989307368846)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(84398357986618534)
,p_name=>'Hide Emirates if overseas is null DA'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(84398492436618535)
,p_event_id=>wwv_flow_api.id(84398357986618534)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(84398819109618538)
,p_name=>'Hide Per Diem/Car if overseas is null DA_1'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(84398902746618539)
,p_event_id=>wwv_flow_api.id(84398819109618538)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P12_CAR_REQUEST_YN'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(91874834959376432)
,p_name=>'get Requestor Cost Center DA'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(91874990898376433)
,p_event_id=>wwv_flow_api.id(91874834959376432)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P12_CC_H,P12_CC_NAME_H'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select cost_center_code , ''('' || cost_center_code || '')- '' ||user_details.get_cost_center_name(cost_center_code) name',
'from employees_v',
'where person_id = :P12_REQUEST_FOR'))
,p_attribute_07=>'P12_REQUEST_FOR'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(91875324447376437)
,p_event_id=>wwv_flow_api.id(91874834959376432)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'apex.item(''P12_COST_CENTER'').setValue($v(''P12_CC_H''),$v(''P12_CC_NAME_H''))'
);
...
'',
'l_payroll_area_id := user_details.get_payroll_area_by_personID(:P12_REQUEST_FOR);',
'',
...
'    ',
'--    MISSION_UTIL.def_supplier_name(''APDT''),       -- payroll_area_vendor_num',
'    MISSION_UTIL.payroll_area_vendor_num(l_payroll_area_id),',
'    vendors_util.vendor_name_by_vendor_num(MISSION_UTIL.payroll_area_vendor_num(l_payroll_area_id)),',
'--    MISSION_UTIL.site_name(''APDT''),',
'    MISSION_UTIL.payroll_area_VENDOR_SITE_CODE(l_payroll_area_id),',
...
'            COST_CENTER =:P12_COST_CENTER,',
'            SUPPLIER_NAME   = vendors_util.vendor_name_by_vendor_num(MISSION_UTIL.payroll_area_vendor_num(l_payroll_area_id)),',
'            SUPPLIER_NUM    = MISSION_UTIL.payroll_area_vendor_num(l_payroll_area_id),',
'            SITE_NAME       = MISSION_UTIL.payroll_area_VENDOR_SITE_CODE(l_payroll_area_id),',
'            payroll_area_id = l_payroll_area_id,',
'            CAR_REQUEST_YN = :P12_CAR_REQUEST_YN',
'     --       ou_code = :OU_CODE',
'    where request_id = :P12_REQUEST_ID;',
'    ',
'    ',
