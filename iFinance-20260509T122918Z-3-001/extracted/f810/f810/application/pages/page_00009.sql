...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47978455892917099)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47979128224917099)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47979446856917100)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47980602690917100)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(47979446856917100)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47980324395917100)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47979861052917100)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(47981438796917100)
,p_branch_action=>'f?p=&APP_ID.:10:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(47980602690917100)
...
'                                      where name = ''Upload Payroll Elements'' and application_id = apex_application.g_flow_id )',
'                            loop',
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(47981868715917101)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47981151432917100)
...
,p_process_when_button_id=>wwv_flow_api.id(47980602690917100)
);
