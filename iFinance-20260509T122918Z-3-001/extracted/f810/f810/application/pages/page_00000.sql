...
,p_last_upd_yyyymmddhh24miss=>'20231018225145'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(12702195018649345)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(12702203223649346)
,p_event_id=>wwv_flow_api.id(12702195018649345)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(210238526530550)
,p_event_id=>wwv_flow_api.id(12702195018649345)
,p_event_result=>'TRUE'
