...
,p_last_upd_yyyymmddhh24miss=>'20231113220944'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(165288897336502421)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(92718350149979285)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(165288897336502421)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92632606282579859)
,p_name=>'P60_RESET_PASSWORD'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(165288897336502421)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92718796744979285)
,p_name=>'P60_NOTES'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(165288897336502421)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(92719177494979291)
,p_name=>'Send EmailOnClick'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(92718350149979285)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(92719686115979292)
,p_event_id=>wwv_flow_api.id(92719177494979291)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(92720212125979292)
,p_event_id=>wwv_flow_api.id(92719177494979291)
,p_event_result=>'TRUE'
...
'        p_template_static_id => ''DUTY_HUB_INVITATION'',',
'        p_placeholders       => ''{'' ||',
...
'        ''   ,"NOTES":''               || apex_json.stringify( :P60_NOTES ) ||    ',
...
'     raise; ',
'end;'))
,p_attribute_02=>'P60_NOTES,P60_RESET_PASSWORD'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(92720712190979292)
,p_event_id=>wwv_flow_api.id(92719177494979291)
,p_event_result=>'TRUE'
