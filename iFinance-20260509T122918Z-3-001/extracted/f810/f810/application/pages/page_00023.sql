...
,p_last_upd_yyyymmddhh24miss=>'20240320093936'
);
...
,p_plug_source=>'<p><strong><span style="color: #0000ff;">This is to confirm that i performed my duty travel as stated.</span></strong></p>'
...
,p_plug_display_point=>'BODY'
,p_plug_source=>'You are going to submit request# &P23_REQUEST_NUMBER. are you sure?'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(101309532008712829)
,p_plug_name=>'Commenet_region'
,p_parent_plug_id=>wwv_flow_api.id(246429890595704)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(78652728867820752)
,p_plug_name=>'Button'
...
,p_button_plug_id=>wwv_flow_api.id(78652728867820752)
...
,p_button_template_id=>wwv_flow_api.id(12960939482762161)
,p_button_image_alt=>'Yes, Confirmed'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(101309474734712828)
,p_name=>'P23_COMMENT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(101309532008712829)
,p_prompt=>'Comment'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(101309717512712830)
,p_name=>'P23_CONFIRMED_START_DATE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(101309532008712829)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(101309785119712831)
,p_name=>'P23_CONFIRMED_END_DATE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(101309532008712829)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(101309978356712833)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Submit Confirm Process_2'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'update mission_header set CONFIRMED_start_DATE = :P23_CONFIRMED_START_DATE ',
'        , CONFIRMED_END_DATE = :P23_CONFIRMED_END_DATE ',
'        , CONFIRMED_COMMENT = :P23_COMMENT',
