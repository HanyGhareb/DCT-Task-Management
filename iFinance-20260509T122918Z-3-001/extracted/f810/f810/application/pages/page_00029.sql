...
,p_name=>'Payroll Vendor Details'
,p_alias=>'PAYROLL-VENDOR-DETAILS'
,p_page_mode=>'MODAL'
,p_step_title=>'Payroll Vendor Details'
...
,p_last_upd_yyyymmddhh24miss=>'20230911193855'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(78650323485820727)
,p_plug_name=>'Audit'
,p_parent_plug_id=>wwv_flow_api.id(2841715076672744)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(78650412785820728)
,p_plug_name=>'Communications'
,p_parent_plug_id=>wwv_flow_api.id(2841715076672744)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(78650793996820732)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(78650911597820733)
,p_plug_name=>'Bank Account Details'
,p_parent_plug_id=>wwv_flow_api.id(2841715076672744)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(78652038691820745)
,p_plug_name=>'User'
,p_parent_plug_id=>wwv_flow_api.id(2841715076672744)
,p_icon_css_classes=>'fa-user'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--showIcon:t-Region--accent1:t-Region--scrollBody:t-Form--large'
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(78650793996820732)
...
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(78650911597820733)
,p_item_source_plug_id=>wwv_flow_api.id(2841715076672744)
...
,p_source_data_type=>'NUMBER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(78650323485820727)
,p_item_source_plug_id=>wwv_flow_api.id(2841715076672744)
,p_prompt=>'Created By'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(78650484215820729)
,p_name=>'P29_EMAIL_TO'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(78650412785820728)
,p_item_source_plug_id=>wwv_flow_api.id(2841715076672744)
,p_prompt=>'Email To'
,p_source=>'EMAIL_TO'
,p_source_type=>'REGION_SOURCE_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(78650532026820730)
,p_name=>'P29_EMAIL_CC'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(78650412785820728)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(78650626324820731)
,p_name=>'P29_EMAIL_BCC'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(78650412785820728)
,p_item_source_plug_id=>wwv_flow_api.id(2841715076672744)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(78652199311820746)
,p_name=>'P29_PERSON_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(78652038691820745)
,p_item_source_plug_id=>wwv_flow_api.id(2841715076672744)
,p_prompt=>'User Name'
,p_source=>'PERSON_ID'
,p_source_type=>'REGION_SOURCE_COLUMN'
