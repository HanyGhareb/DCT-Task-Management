...
,p_last_upd_yyyymmddhh24miss=>'20200825052039'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(5069046499045120)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(5069155950045121)
,p_event_id=>wwv_flow_api.id(5069046499045120)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(5069266677045122)
,p_event_id=>wwv_flow_api.id(5069046499045120)
,p_event_result=>'TRUE'
...
'            else  ',
'',
'           ''http://s1defp1.dev.uae:7001/ords/dev/profile/view/'' || upper(e.user_name)',
'           end IMAGE  ,',
'''#'' EDIT_LINK, ',
