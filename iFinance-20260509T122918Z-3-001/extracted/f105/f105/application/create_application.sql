...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Fund Management')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'FUND-MGMT')
...
,p_authentication_id=>wwv_flow_api.id(105349636493400341)
,p_application_tab_set=>1
,p_logo_type=>'IT'
,p_logo=>'#WORKSPACE_IMAGES#app-logo.png'
,p_logo_text=>'<cite>i-<b>finance - Fund Management </b></cite>'
...
,p_substitution_value_01=>'Fund Management'
