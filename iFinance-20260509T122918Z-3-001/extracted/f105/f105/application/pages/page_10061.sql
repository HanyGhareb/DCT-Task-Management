...
,p_required_patch=>wwv_flow_api.id(99844270137410809)
,p_dialog_chained=>'N'
,p_last_updated_by=>'TCA9051'
,p_last_upd_yyyymmddhh24miss=>'20220316183731'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(99992622705411044)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(99993088659411044)
,p_name=>'P10061_PAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(99992622705411044)
