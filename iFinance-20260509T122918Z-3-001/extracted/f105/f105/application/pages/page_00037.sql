...
,p_name=>'Projects Data Load Source'
,p_alias=>'PROJECTS-DATA-LOAD-SOURCE'
,p_step_title=>'Projects Data Load Source'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'TCA9051'
,p_last_upd_yyyymmddhh24miss=>'20220808042708'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6227021643088668)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6227741600088669)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6228084345088669)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95382005452252341)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(6228084345088669)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95381583765252346)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(95364376945252366)
,p_branch_name=>'Go To Page 46'
,p_branch_action=>'f?p=&APP_ID.:38:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(95382005452252341)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95381229007252346)
,p_name=>'P37_IMPORT_FROM'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6228084345088669)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95380767497252349)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95380381086252349)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95379506144252352)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95378653365252353)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95377760607252354)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95376875217252355)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95375940198252355)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95375079401252356)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95374132781252356)
,p_name=>'P37_CURRENCY'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(6228084345088669)
,p_item_default=>'$'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95373297403252356)
,p_name=>'P37_CHAR_SET'
,p_is_required=>true
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(6228084345088669)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95372379167252357)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(95370793235252361)
...
,p_when_button_pressed=>wwv_flow_api.id(95382005452252341)
,p_associated_item=>wwv_flow_api.id(95380381086252349)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(95370369258252361)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(95382005452252341)
,p_associated_item=>wwv_flow_api.id(95380767497252349)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(95369693854252362)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95369167340252363)
,p_event_id=>wwv_flow_api.id(95369693854252362)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95368731270252364)
,p_event_id=>wwv_flow_api.id(95369693854252362)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(95368255385252364)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95367804071252364)
,p_event_id=>wwv_flow_api.id(95368255385252364)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95367242018252364)
,p_event_id=>wwv_flow_api.id(95368255385252364)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95366747780252364)
,p_event_id=>wwv_flow_api.id(95368255385252364)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(95366348045252365)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95365852346252365)
,p_event_id=>wwv_flow_api.id(95366348045252365)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95365410561252365)
,p_event_id=>wwv_flow_api.id(95366348045252365)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95364894747252365)
,p_event_id=>wwv_flow_api.id(95366348045252365)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95370112673252361)
...
,p_process_when_button_id=>wwv_flow_api.id(95382005452252341)
);
