...
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(101018636675982063)
,p_name=>'test'
...
,p_report_layout_id=>wwv_flow_api.id(104676911522644462)
,p_format=>'PDF'
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(101015834223990983)
,p_shared_query_id=>wwv_flow_api.id(101018636675982063)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(101015731856990983)
,p_shared_query_id=>wwv_flow_api.id(101018636675982063)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT',
'    FROM_TO,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(101015441729990983)
,p_shared_query_id=>wwv_flow_api.id(101018636675982063)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT',
'--    id,',
