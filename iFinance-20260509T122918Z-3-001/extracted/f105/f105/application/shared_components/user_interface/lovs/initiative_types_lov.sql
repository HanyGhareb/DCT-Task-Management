...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(751483607077011)
,p_lov_name=>'INITIATIVE TYPES LOV'
,p_lov_query=>'.'||wwv_flow_api.id(751483607077011)||'.'
,p_location=>'STATIC'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(751835229077012)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Strategic'
,p_lov_return_value=>'S'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(752201718077013)
