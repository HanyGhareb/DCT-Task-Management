prompt --application/shared_components/user_interface/lovs/dp_item_participant_roles
begin
--   Manifest
--     DP ITEM PARTICIPANT ROLES
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(64248654316166126)
,p_lov_name=>'DP ITEM PARTICIPANT ROLES'
