prompt --application/shared_components/email/templates/fyi_cc_plan_finally_approved
begin
--   Manifest
--     REPORT LAYOUT: FYI CC Proposal Plan finally approved
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(41221391269756824)
,p_name=>'FYI CC Proposal Plan finally approved'
,p_static_id=>'FYI_CC_PLAN_FINALLY_APPROVED'
,p_subject=>'FYI - Budget Proposal Plan for #COST_CENTER_NAME# - #COST_CENTER# has been Approved'
