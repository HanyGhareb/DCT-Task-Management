prompt --application/shared_components/email/templates/fyi_end_user_budget_transfer_finally_approved
begin
--   Manifest
--     REPORT LAYOUT: FYI End User Budget Transfer finally approved
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(1410915800989078)
,p_name=>'FYI End User Budget Transfer finally approved'
,p_static_id=>'FYI_END_USER_BUDGET_TRANSFER_FINALLY_APPROVED'
,p_subject=>'FYI - Budget Transfer for #REQUESTOR#, Amount: #AMOUNT# has been Approved'
