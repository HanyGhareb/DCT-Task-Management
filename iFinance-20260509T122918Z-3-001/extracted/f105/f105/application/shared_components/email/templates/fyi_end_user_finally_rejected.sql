...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(1411756098967894)
...
'<p>Kindly note that budget transfer request# #REQUEST_NO# has been <strong><span style="color: #ff0000;">Rejected,</span></strong></p>',
