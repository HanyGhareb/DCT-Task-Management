prompt --application/shared_components/email/templates/reminder_btf_action_required
begin
--   Manifest
--     REPORT LAYOUT: Reminder BTF Action required
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(104366226522801483)
,p_name=>'Reminder BTF Action required'
,p_static_id=>'REMINDER_BTF_ACTION_REQUIRED'
,p_subject=>'Reminder- Action Required - Budget Transfer for #REQUESTOR#,  Amount: #AMOUNT# AED.'
