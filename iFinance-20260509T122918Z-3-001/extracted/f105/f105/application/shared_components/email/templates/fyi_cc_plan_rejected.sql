prompt --application/shared_components/email/templates/fyi_cc_plan_rejected
begin
--   Manifest
--     REPORT LAYOUT: FYI CC Proposal Plan finally Rejected
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(41221133401740934)
,p_name=>'FYI CC Proposal Plan finally Rejected'
,p_static_id=>'FYI_CC_PLAN_REJECTED'
,p_subject=>'FYI - Budget Proposal Plan for #COST_CENTER_NAME# - #COST_CENTER# has been REJECTED'
...
'<p>has been <strong><span style="color: #ff0000;">Rejected,</span></strong></p>',
