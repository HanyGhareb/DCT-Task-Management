prompt --application/shared_components/email/templates/remindar_approve_reject_petty_cash
begin
--   Manifest
--     REPORT LAYOUT: Reminder Approve Reject Petty Cash
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(7038756263860014)
,p_name=>'Reminder Approve Reject Petty Cash'
,p_static_id=>'REMINDAR_APPROVE_REJECT_PETTY_CASH'
,p_subject=>'Reminder: Action Required: Petty Cash request for #EMP_NAME# , Amount #AMOUNT#'
...
'<br>',
'<br>',
'This is kind reminder for action required for Petty Cash Request# <span style="color: #0e6654;"><i>#PETTY_CASH_NO#</i></span> for employee: <span style="color: #0e6654;"><i>#EMP_NAME#</i></span><br>',
'<br>',
'',
