prompt --application/shared_components/email/templates/final_reject_expense_report
begin
--   Manifest
--     REPORT LAYOUT: Final Reject Expense Report
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(6455693108972218)
,p_name=>'Final Reject Expense Report'
,p_static_id=>'FINAL_REJECT_EXPENSE_REPORT'
,p_subject=>'Your expense report# #EXPENSE_REPORT_NUM#  has been Rejected'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello <b><span style="color: #0e6654;"><i>#EMP_NAME#,</i></span></b>',
'<br>',
'',
'Please note that your Expense report# <span style="color: #0e6654;"><i>#EXPENSE_REPORT_NUM#</i></span> has been <p style="color:red;">Rejected</p>.',
'',
'',
'Here is the expense report Details:',
'',
'',
...
'<br>',
'',
'you can check request updates from ifinance system. ',
'<br>',
'<table border="0" align="center">                      ',
'	<tbody><tr>',
'				<td style="padding:16px 24px;border-radius:4px;min-width:200px;" bgcolor="#0e6654" align="center">',
'                          <a rel="nofollow" target="_blank" href="#APPLICATION_LINK#" style="font-size:16px;line-height:16px;font-weight:700;color:#FCFBFA;text-decoration:none;display:inline-block;padding:16px 24px;"> i-Finance Access </a>           '
||'             ',
'				</td>                      ',
'			</tr>                    ',
'	</tbody>',
