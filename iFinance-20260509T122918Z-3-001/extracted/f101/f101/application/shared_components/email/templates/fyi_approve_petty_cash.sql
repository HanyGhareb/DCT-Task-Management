prompt --application/shared_components/email/templates/fyi_approve_petty_cash
begin
--   Manifest
--     REPORT LAYOUT: FYI Approve Petty Cash
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(5462089415936212)
,p_name=>'FYI Approve Petty Cash'
,p_static_id=>'FYI_APPROVE_PETTY_CASH'
,p_subject=>'FYI - Petty Cash# #PETTY_CASH_NO# for  #EMP_NAME#, Amount #AMOUNT#  has been Approved'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello <b><span style="color: #0e6654;"><i>#APPROVER_EMP_NAME#,</i></span></b>',
'<br>',
'<br>',
'Please note that Petty Cash Request# <span style="color: #0e6654;"><i>#PETTY_CASH_NO#</i></span> for for employee: <span style="color: #0e6654;"><i>#EMP_NAME#</i></span> has been <span style="color: #0e6654;"><i>finally approved</i></span>.',
'<br>',
'<br>',
...
'</table>',
'<br>',
'you can check the petty cash request details from i-Finance system.',
'<br>',
'<br>',
