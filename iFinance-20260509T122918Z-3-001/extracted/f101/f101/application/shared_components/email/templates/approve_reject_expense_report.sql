prompt --application/shared_components/email/templates/approve_reject_expense_report
begin
--   Manifest
--     REPORT LAYOUT: Approve Reject Expense Report
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(6455263694931770)
,p_name=>'Approve Reject Expense Report'
,p_static_id=>'APPROVE_REJECT_EXPENSE_REPORT'
,p_subject=>'Action Required: Expense Report for #EMP_NAME# , Amount #AMOUNT#'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello <b><span style="color: #0e6654;"><i>#APPROVER_EMP_NAME#,</i></span></b>',
'<br>',
'your kind attention is required to expense report# <span style="color: #0e6654;"><i>#EXPENSE_REPORT_NUM#</i></span> for employee: <span style="color: #0e6654;"><i>#EMP_NAME#</i></span> with amount <span style="color: #0e6654;"><i>#AMOUNT#</i></span><'
||'br>',
'',
