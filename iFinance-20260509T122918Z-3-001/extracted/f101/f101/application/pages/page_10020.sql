...
,p_required_patch=>wwv_flow_api.id(1330701623915072)
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Select the default color scheme used to display the application.</p>',
'<p>If <strong>Allow End Users to choose Theme Style</strong> is checked, then each end user can select from the available theme styles by clicking the <em>Customize</em> link in the bottom left corner of the Home page.</p>'))
,p_last_updated_by=>'TCA9051'
,p_last_upd_yyyymmddhh24miss=>'20210425054743'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330537066915073)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330404727915073)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1328792164915077)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1330537066915073)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1329201311915076)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1328336174915078)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1328028362915078)
,p_name=>'P10020_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(1330404727915073)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1327367944915090)
...
,p_lov=>'.'||wwv_flow_api.id(1327264534915090)||'.'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1330213435915074)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(1329201311915076)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1325855211915093)
,p_event_id=>wwv_flow_api.id(1330213435915074)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1325367720915093)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1324904449915094)
