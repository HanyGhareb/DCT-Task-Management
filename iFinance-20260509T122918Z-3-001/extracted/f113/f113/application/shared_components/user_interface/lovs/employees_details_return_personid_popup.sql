...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(70553135183896)
,p_lov_name=>'EMPLOYEES DETAILS  RETURN PERSONID- POPUP'
,p_reference_id=>92524963119408839
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(74559458183898)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(74971354183898)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(75343613183898)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(75802689183899)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(76106095183899)
