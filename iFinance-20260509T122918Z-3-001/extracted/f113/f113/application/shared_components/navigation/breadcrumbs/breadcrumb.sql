...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(86072061505348)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(1258412177203071)
,p_parent_id=>wwv_flow_api.id(86072061505348)
,p_short_name=>'Payment Request document'
,p_link=>'f?p=&APP_ID.:4:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>4
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(1526856931006744)
,p_parent_id=>wwv_flow_api.id(99703628875410717)
,p_short_name=>'Payment Request Approve/Reject'
