prompt --application/shared_components/email/templates/fyi_payment_request_finally_rejected
begin
--   Manifest
--     REPORT LAYOUT: FYI Payment Request finally rejected
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(2914325644741129)
,p_name=>'FYI Payment Request finally rejected'
,p_static_id=>'FYI_PAYMENT_REQUEST_FINALLY_REJECTED'
,p_subject=>'FYI - Payment Request  for #REQUESTOR#, Amount: #AMOUNT# has been Rejected'
...
'<p><span>Below payment request has been <strong><span style="color: #ff0000;">Rejected,</span></strong></span></p>',
