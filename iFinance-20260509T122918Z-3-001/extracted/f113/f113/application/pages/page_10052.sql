...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(99957667571411007)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(99957714748411007)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(99957904145411007)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(99957714748411007)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(99957864889411007)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(99969617827411017)
,p_name=>'P10052_FEEDBACK_ATTACHMENTS_YN'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(99957667571411007)
,p_item_default=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(99958099225411007)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(99957904145411007)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(99970473727411017)
,p_event_id=>wwv_flow_api.id(99958099225411007)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(99970948207411018)
...
,p_process_when_button_id=>wwv_flow_api.id(99957864889411007)
,p_process_success_message=>'Feedback settings updated.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(99971343953411018)
