...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Payment Requests')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'IFINANCE-PAY-REQ')
...
,p_logo_text=>'<cite>i-<b>finance - Payment Requests</b></cite>'
...
,p_substitution_value_01=>'Payment Requests'
