prompt --application/shared_components/user_interface/lovs/tac_committee_roles_active_lov
begin
--   Manifest
--     TAC COMMITTEE  ROLES ACTIVE - LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(26650222993628901)
,p_lov_name=>'TAC COMMITTEE  ROLES ACTIVE - LOV'
