prompt --application/shared_components/user_interface/lovs/preference_types_active_lov
begin
--   Manifest
--     PREFERENCE TYPES ACTIVE -LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(28328982727941318)
,p_lov_name=>'PREFERENCE TYPES ACTIVE -LOV'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select value , value_id ',
'from DCT_LOOKUP_VALUES ',
'where lookup_id = (select l.lookup_id ',
'                    from dct_lookups l ',
'                    where l.lookup_code = ''PREF_TYPE'') ',
'    and status = ''A'' ',
