prompt --application/shared_components/email/templates/tac_form_delegate_to
begin
--   Manifest
--     REPORT LAYOUT: TAC Form Delegate To
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(69824723891933867)
,p_name=>'TAC Form Delegate To'
,p_static_id=>'TAC_FORM_DELEGATE_TO'
,p_subject=>'Action required- #PURPOSE# Request, Amount: #ESTIMATED_BUDGET# for #REQUESTOR#'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Dear <strong><span style="color: #003366;">#APPROVER_TITLE# #APPROVER_NAME#</span></strong>, <br /><br /></p>',
'<p>below #PURPOSE# Request has been delegated to you.</p>',
