prompt --application/shared_components/email/templates/ss_delegate_to
begin
--   Manifest
--     REPORT LAYOUT: SS Delegate To
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(69401249612580775)
,p_name=>'SS Delegate To'
,p_static_id=>'SS_DELEGATE_TO'
...
'<p>below single source request has been delegated to you.</p>',
