prompt --application/shared_components/email/templates/tac_form_rejected_finally
begin
--   Manifest
--     REPORT LAYOUT: TAC Form Rejected Finally
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(69824201294908067)
,p_name=>'TAC Form Rejected Finally'
,p_static_id=>'TAC_FORM_REJECTED_FINALLY'
,p_subject=>'FYI- #PURPOSE# Request,Amount: #ESTIMATED_BUDGET# form #REQUESTOR_NAME#  Rejected'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Dear <strong><span style="color: #003366;">#APPROVER_TITLE# #APPROVER_NAME#</span></strong>, <br /><br />Below #PURPOSE# Request has been <strong><span style="color: #ff0000;"><em>Rejected </em></span></strong><span style="color: #ff0000;"><span s'
||'tyle="color: #000000;">by <strong>#ACTION_DONE_BY#</strong></span></span></p>',
'<p><span style="color: #ff0000;"><em>#COMMENTS#</em></span></p>',
'<table style="height: 426px; width: 120%; border-collapse: collapse;" border="0">',
'<tbody>',
'<tr style="height: 18px;">',
'<td style="width: 45.3857%; height: 18px; background-color: #00008b;" colspan="3"><span style="color: #ffffff;"><strong><em>FYI - #PURPOSE# Approval</em></strong></span></td>',
'</tr>',
'<tr style="height: 18px;">',
