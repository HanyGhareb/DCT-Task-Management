prompt --application/shared_components/email/templates/single_source_action_approved_finally
begin
--   Manifest
--     REPORT LAYOUT: Single Source Action Approved Finally
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(66893471743368743)
,p_name=>'Single Source Action Approved Finally'
,p_static_id=>'SINGLE_SOURCE_ACTION_APPROVED_FINALLY'
,p_subject=>'FYI - Single Source Req #REQUEST_NUMBER#,Amount: #ESTIMATED_BUDGET# form #REQUESTOR# Finally Approved'
