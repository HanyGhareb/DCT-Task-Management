...
,p_last_updated_by=>'TCA400'
,p_last_upd_yyyymmddhh24miss=>'20220912094116'
);
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(18784913367924957)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(18784578345924957)
,p_report_id=>wwv_flow_api.id(26863437509090513)
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'APPROVAL_STATUS'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(18784154953924958)
,p_report_id=>wwv_flow_api.id(26863437509090513)
,p_name=>'Reject'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
