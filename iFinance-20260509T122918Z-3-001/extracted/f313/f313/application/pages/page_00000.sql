...
,p_last_upd_yyyymmddhh24miss=>'20220103062603'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(25592724038328941)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(25592890474328942)
,p_event_id=>wwv_flow_api.id(25592724038328941)
,p_event_result=>'TRUE'
,p_action_sequence=>5
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(25592928083328943)
,p_event_id=>wwv_flow_api.id(25592724038328941)
,p_event_result=>'TRUE'
...
'FROM',
'    SCM_SINGLE_SOURCE_NOTIFICATIONS',
'union all',
'select   note_icon,',
'    note_icon_color,',
'    note_header,',
...
'    note_decline,',
'    no_browser_notification',
'  from TAC_FORM_NOTIFICATIONS',
''))
,p_attribute_05=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(23092225668022163)
,p_name=>'AutoHideSuccessMessage'
,p_event_sequence=>20
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(23092287909022164)
,p_event_id=>wwv_flow_api.id(23092225668022163)
,p_event_result=>'TRUE'
