...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(18779671926963661)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(18779243704963662)
,p_report_id=>wwv_flow_api.id(24711845860319017)
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'APPROVAL_STATUS'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(18778798285963662)
,p_report_id=>wwv_flow_api.id(24711845860319017)
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'APPROVAL_STATUS'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(18778460662963662)
,p_report_id=>wwv_flow_api.id(24711845860319017)
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'APPROVAL_STATUS'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(16707793140535019)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(16707439187535020)
,p_report_id=>wwv_flow_api.id(69741746944139300)
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'APPROVAL_STATUS'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(16707043674535020)
,p_report_id=>wwv_flow_api.id(69741746944139300)
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'APPROVAL_STATUS'
