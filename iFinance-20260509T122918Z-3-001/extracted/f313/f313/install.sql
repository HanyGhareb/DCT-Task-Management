...
@@application/shared_components/logic/application_items/forward_to_buyer.sql
@@application/shared_components/logic/application_items/is_buyer.sql
@@application/shared_components/logic/application_items/is_committee_secretary.sql
@@application/shared_components/logic/application_items/is_single_source_admin.sql
@@application/shared_components/logic/application_items/is_souceing_manager.sql
@@application/shared_components/logic/application_items/is_supply_management_unit_head.sql
@@application/shared_components/logic/application_items/person_id.sql
@@application/shared_components/logic/application_items/single_source_request_count.sql
@@application/shared_components/logic/application_items/tac_form_count.sql
@@application/shared_components/logic/application_computations/person_id.sql
@@application/shared_components/logic/application_computations/forward_to_buyer.sql
@@application/shared_components/logic/application_computations/is_committee_secretary.sql
@@application/shared_components/logic/application_computations/is_souceing_manager.sql
@@application/shared_components/logic/application_computations/is_supply_management_unit_head.sql
...
@@application/shared_components/logic/application_computations/single_source_request_count.sql
@@application/shared_components/logic/application_computations/is_single_source_admin.sql
@@application/shared_components/logic/application_computations/is_buyer.sql
@@application/shared_components/logic/application_computations/tac_form_count.sql
...
@@application/shared_components/user_interface/lovs/all_manual_and_standard_prs_lov.sql
...
@@application/shared_components/user_interface/lovs/preference_types_active_lov.sql
@@application/shared_components/user_interface/lovs/single_sources_to_tac_form_approved_lov.sql
@@application/shared_components/user_interface/lovs/status_lov.sql
@@application/shared_components/user_interface/lovs/tac_committee_roles_active_lov.sql
@@application/shared_components/user_interface/lovs/tac_committee_types_active_lov.sql
@@application/shared_components/user_interface/lovs/tac_form_purposes_active_lov.sql
@@application/shared_components/user_interface/lovs/tac_form_purposes_all_lov.sql
@@application/shared_components/user_interface/lovs/tac_meeting_outcomes_types.sql
@@application/shared_components/user_interface/lovs/tasks_by_cost_centers_lov.sql
@@application/shared_components/user_interface/lovs/tca_decision_options_lov.sql
...
@@application/shared_components/reports/report_queries/single_source_query.sql
@@application/shared_components/reports/report_queries/tac_form_query.sql
@@application/shared_components/reports/report_layouts/single_source_form.sql
@@application/shared_components/reports/report_layouts/tac_form.sql
@@application/shared_components/email/templates/single_source_action_required.sql
@@application/shared_components/email/templates/single_source_action_approved_finally.sql
@@application/shared_components/email/templates/single_source_action_rejected_finally.sql
@@application/shared_components/email/templates/single_source_action_approved.sql
@@application/shared_components/email/templates/ss_delegate_from.sql
@@application/shared_components/email/templates/ss_delegate_to.sql
@@application/shared_components/email/templates/tac_form_action_required.sql
@@application/shared_components/email/templates/tac_form_action_approved_finally.sql
@@application/shared_components/email/templates/tac_form_rejected_finally.sql
@@application/shared_components/email/templates/tac_form_delegate_from.sql
@@application/shared_components/email/templates/tac_form_delegate_to.sql
