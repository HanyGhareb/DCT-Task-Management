...
,p_last_upd_yyyymmddhh24miss=>'20230521102342'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(166554822557736401)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(166554974688736402)
,p_event_id=>wwv_flow_api.id(166554822557736401)
,p_event_result=>'TRUE'
...
'select nvl(full_name_en, SF_EMPLOYEE_NAME) USERNAME,',
...
'           end IMAGE  ,',
'           apex_util.prepare_url( ''f?p=100''||'':2:''||:APP_SESSION||''::NO::P2_USER_NAME:''|| user_name ) EDIT_LINK,',
'           email EMAIL, ',
'           e.mobile PHONE_NO,',
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(166555078452736403)
,p_event_id=>wwv_flow_api.id(166554822557736401)
,p_event_result=>'TRUE'
...
'FROM',
'    MANAGER_CHECKS_NOTIFICATIONS_V',
'union all',
'    ',
'    SELECT',
'    note_icon,',
