...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(156968300457712116)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(156969038336712116)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(156969317671712116)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(156970583720712117)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(156969317671712116)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(156970246064712117)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(156969714082712116)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(156971304876712117)
,p_branch_action=>'f?p=&APP_ID.:16:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(156970583720712117)
...
'                                      where name = ''Upload Customers Outstanding'' and application_id = apex_application.g_flow_id )',
'                            loop',
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(156971738223712117)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(156971025549712117)
...
,p_process_when_button_id=>wwv_flow_api.id(156970583720712117)
);
