...
@@application/shared_components/navigation/lists/data_load_wizard_progress_update_customers_emails.sql
@@application/shared_components/navigation/lists/data_load_wizard_progress_upload_customers_outstanding.sql
@@application/shared_components/navigation/lists/data_load_wizard_progress_upload_hotel_pl.sql
@@application/shared_components/files/app_icon_svg.sql
@@application/shared_components/files/app_icon_css.sql
@@application/shared_components/files/upload_template_xlsx.sql
...
@@application/shared_components/user_interface/lovs/ar_categories.sql
@@application/shared_components/user_interface/lovs/ar_categories_all.sql
@@application/shared_components/user_interface/lovs/ar_category_parent.sql
@@application/shared_components/user_interface/lovs/ar_main_categories.sql
@@application/shared_components/user_interface/lovs/ar_sub_categories.sql
...
@@application/shared_components/user_interface/lovs/emp_by_emails_popup.sql
@@application/shared_components/user_interface/lovs/employees_list.sql
...
@@application/shared_components/reports/report_queries/freindly_ar_payment.sql
@@application/shared_components/email/templates/friendly_reminder_ar_due_1.sql
@@application/shared_components/email/templates/official_reminder_ar_due_2.sql
@@application/shared_components/email/templates/official_reminder_ar_due_3.sql
@@application/shared_components/email/templates/hotel_outstanding.sql
@@application/shared_components/email/templates/hotels_pl.sql
...
@@application/shared_components/data_loading/tables/customers.sql
@@application/shared_components/data_loading/tables/ar_customers_outstanding.sql
@@application/shared_components/data_loading/tables/ar_hotels_p_l.sql
