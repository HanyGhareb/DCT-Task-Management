...
@@application/shared_components/navigation/lists/projects_end_user_reports_list.sql
@@application/shared_components/navigation/lists/fbp_reports_list.sql
@@application/shared_components/files/app_icon_svg.sql
@@application/shared_components/files/app_icon_css.sql
@@application/shared_components/files/app_54293_logo_png.sql
@@application/shared_components/files/digitalbanking_icon_fund_transfer_blue_png.sql
@@application/shared_components/files/app_icon_png.sql
...
@@application/shared_components/security/authorizations/fbp_auz_role.sql
@@application/shared_components/security/authorizations/budget_planning_auz_role.sql
@@application/shared_components/security/authorizations/approver_auz_role.sql
@@application/shared_components/security/authorizations/project_end_user.sql
...
@@application/shared_components/security/app_access_control/fbp_acl_role.sql
@@application/shared_components/security/app_access_control/budget_planning_acl_role.sql
@@application/shared_components/security/app_access_control/finance_admin.sql
@@application/shared_components/security/app_access_control/btf_approvers_role.sql
@@application/shared_components/security/app_access_control/project_end_user.sql
@@application/shared_components/navigation/navigation_bar.sql
@@application/shared_components/logic/application_items/emp_name.sql
@@application/shared_components/logic/application_items/projects_user.sql
@@application/shared_components/logic/application_items/user_access_dept.sql
@@application/shared_components/logic/application_items/user_access_sector.sql
@@application/shared_components/logic/application_computations/emp_name.sql
@@application/shared_components/logic/application_computations/user_access_sector.sql
@@application/shared_components/logic/application_computations/user_access_dept.sql
@@application/shared_components/logic/application_computations/projects_user.sql
@@application/shared_components/logic/application_computations/projects_user_002.sql
...
@@application/shared_components/user_interface/lovs/purpose_eu_lov.sql
...
@@application/shared_components/email/templates/test.sql
@@application/shared_components/email/templates/test2.sql
@@application/shared_components/security/authentications/application_express_authentication.sql
@@application/shared_components/plugins/region_type/com_planetapex_kpi_numeric_cards.sql
