prompt --application/shared_components/navigation/lists/projects_end_user_reports_list
begin
--   Manifest
--     LIST: Projects End User Reports List
--   Manifest End
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(77143213799966391)
,p_name=>'Projects End User Reports List'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(77143475333966391)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Transfer Requests By Project'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(77143893943966391)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(77144250904966391)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(77144632933966392)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(77157870913999014)
