...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55702366243072888)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55702481078072888)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55702611586072888)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(55702481078072888)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55702561378072888)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55714382458072898)
,p_name=>'P10052_FEEDBACK_ATTACHMENTS_YN'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(55702366243072888)
,p_item_default=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(55702788525072888)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(55702611586072888)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(55715102036072898)
,p_event_id=>wwv_flow_api.id(55702788525072888)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55715625985072899)
...
,p_process_when_button_id=>wwv_flow_api.id(55702561378072888)
,p_process_success_message=>'Feedback settings updated.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55716011946072899)
