...
,p_last_upd_yyyymmddhh24miss=>'20200606111727'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(29695747392734873)
,p_plug_name=>'Search'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29520149839078344)
,p_name=>'P17_PETTY_CASH_ID_H'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(29695747392734873)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29520439672078347)
,p_name=>'P17_PETTY_CASH_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(29695747392734873)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29696125374734873)
,p_name=>'P17_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(29695747392734873)
,p_prompt=>'Search'
