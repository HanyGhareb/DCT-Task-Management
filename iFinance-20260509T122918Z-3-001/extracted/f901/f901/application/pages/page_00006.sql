...
,p_last_upd_yyyymmddhh24miss=>'20200608114358'
);
...
,p_plug_read_only_when=>':P6_APPROVAL_STATUS not in (''Draft'' , ''Stoped'')'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(37270567671549974)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43080360830243917)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43080712543243917)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43081115488243917)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'STEP_NO:POSITION:ACTION_REQUIRED:USER_NAME:STATUS:RECEVIED_DATE:ACTION_DATE:COMMENTS::PHOTO'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(43086789059243921)
...
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_redirect_url=>'f?p=&APP_ID.:4:&SESSION.::&DEBUG.::P4_PETTY_CASH_ID,P4_APPROVAL_STATUS,P4_PETTY_CASH_NO:&P6_PETTY_CASH_ID.,&P6_APPROVAL_STATUS.,&P6_PETTY_CASH_NO.'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29068199961117376)
...
,p_attribute_08=>'500'
,p_attribute_09=>'500'
,p_attribute_10=>'SECTOR:P6_SECTOR,DEPARTMENT:P6_DEPARTMENT,PROJECT_NAME:P6_PROJECT_NAME'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29068526759117376)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29068906717117376)
,p_name=>'P6_SECTOR'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(37282904323566301)
,p_prompt=>'Sector'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29069360066117377)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29069798531117377)
,p_name=>'P6_TASK'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(37282904323566301)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29070176839117377)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29070523843117377)
...
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(37270567671549974)
,p_item_source_plug_id=>wwv_flow_api.id(37282904323566301)
,p_prompt=>'Created By'
,p_source=>'CREATED_BY'
,p_source_type=>'REGION_SOURCE_COLUMN'
...
'begin',
'HRSS_WORKFLOW.approve_petty_cash(:P6_PETTY_CASH_ID , :APP_USER);',
'',
'',
'end;'))
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'HRSS_WORKFLOW.reject_petty_cash(:P6_PETTY_CASH_ID , :APP_USER);',
'',
'',
'end;'))
,p_attribute_02=>'P6_PETTY_CASH_ID'
