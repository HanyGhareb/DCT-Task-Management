...
,p_last_updated_by=>'TCA596'
,p_last_upd_yyyymmddhh24miss=>'20200608121002'
);
...
'           end Photo',
'  from expense_report_approval_history pc,  dct_employees_list2  e',
'  where pc.user_name = e.user_name (+)',
'and  pc.expense_report_id = :P12_EXPENSE_REPORT_ID'))
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46554863882858734)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'STEP_NO:POSITION:ACTION_REQUIRED:USER_NAME:STATUS:RECEVIED_DATE:ACTION_DATE:PHOTO:'
,p_sort_column_1=>'STEP_NO'
,p_sort_direction_1=>'ASC'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(46952228540475971)
