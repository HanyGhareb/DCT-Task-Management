...
,p_last_upd_yyyymmddhh24miss=>'20200605093955'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(29268149292292301)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(29268204320292302)
,p_event_id=>wwv_flow_api.id(29268149292292301)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(29960464317468911)
,p_event_id=>wwv_flow_api.id(29268149292292301)
,p_event_result=>'TRUE'
