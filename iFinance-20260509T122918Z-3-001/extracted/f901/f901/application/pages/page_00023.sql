...
,p_last_upd_yyyymmddhh24miss=>'20200606095430'
);
...
,p_plug_display_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_plug_display_when_condition=>'P23_NOTE_HEADER'
,p_plug_display_when_cond2=>'Petty Cash Approved'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(67274737170635278)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30034062431085325)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30034400949085325)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30034830592085325)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'STEP_NO:POSITION:ACTION_REQUIRED:EMPLOYEE_NAME:USER_NAME:STATUS:RECEVIED_DATE:ACTION_DATE::PHOTO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30017243012085312)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30017684346085312)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30018087027085313)
,p_name=>'P23_SECTOR'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(67287073822651605)
,p_prompt=>'Sector'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30018417240085313)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30018841064085313)
,p_name=>'P23_TASK'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(67287073822651605)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30019252648085313)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30019690669085313)
...
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(67274737170635278)
,p_item_source_plug_id=>wwv_flow_api.id(67287073822651605)
,p_prompt=>'Created By'
,p_source=>'CREATED_BY'
,p_source_type=>'REGION_SOURCE_COLUMN'
...
'set acknowledge = ''Y''',
'where id = :P23_ID'))
,p_attribute_02=>'P23_PETTY_CASH_ID'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
