...
,p_last_upd_yyyymmddhh24miss=>'20210209070142'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(11870625825373938)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20782896100193920)
,p_event_id=>wwv_flow_api.id(11870625825373938)
,p_event_result=>'TRUE'
,p_action_sequence=>5
...
'           end IMAGE  ,',
'--''#'' EDIT_LINK, ',
'apex_util.prepare_url( ''f?p=''||:APP_ID||'':9:''||:APP_SESSION||''::NO::P9_USER_ID:''|| e.user_id ) EDIT_LINK,',
'email EMAIL, ',
'e.phone_number      PHONE_NO,',
'e.designation                  DESIGNATION,',
'e.department                  DEPARTMENT,',
'(select v.vendor_name',
'    from vendors v',
'    where v.vendor_number = e.vendor_number',
'    and v.vendor_site_code = e.vendor_site_code) COMPANY',
'FROM dct_ext_users e',
'where user_name = :APP_USER;'))
,p_attribute_05=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(11870705970373939)
,p_event_id=>wwv_flow_api.id(11870625825373938)
,p_event_result=>'TRUE'
