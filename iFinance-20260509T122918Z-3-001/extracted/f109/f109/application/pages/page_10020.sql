...
,p_required_patch=>wwv_flow_api.id(21688134657253941)
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Select the default color scheme used to display the application.</p>',
'<p>If <strong>Allow End Users to choose Theme Style</strong> is checked, then each end user can select from the available theme styles by clicking the <em>Customize</em> link in the bottom left corner of the Home page.</p>'))
,p_last_updated_by=>'TCA9051'
,p_last_upd_yyyymmddhh24miss=>'20210210062004'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21688319161253941)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21688454328253941)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21690192503253942)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(21688319161253941)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21689618336253942)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(21690578320253943)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21690862685253943)
,p_name=>'P10020_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(21688454328253941)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21691421993253951)
...
,p_lov=>'.'||wwv_flow_api.id(21691555822253951)||'.'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(21688697210253941)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(21689618336253942)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(21692970713253952)
,p_event_id=>wwv_flow_api.id(21688697210253941)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(21693460691253952)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(21693839054253953)
