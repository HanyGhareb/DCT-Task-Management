...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21647618442251775)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21647787018251775)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21647817525251775)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(21647787018251775)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21647904385251775)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21648042255251775)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21662870805251785)
,p_name=>'P10014_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(21647618442251775)
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21663205027251785)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21663638272251786)
,p_name=>'P10014_FILED'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(21647618442251775)
,p_prompt=>'Filed'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21664085807251786)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21664489516251786)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21664887152251786)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21665278605251787)
...
,p_lov=>'.'||wwv_flow_api.id(21665319751251787)||'.'
,p_field_template=>wwv_flow_api.id(11194027339956088)
,p_lov_display_extra=>'NO'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21667504425251788)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21667993288251788)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(21648149012251775)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(21647904385251775)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(21668765332251789)
,p_event_id=>wwv_flow_api.id(21648149012251775)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(21669232543251789)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(21669691510251789)
,p_process_sequence=>10
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(21647817525251775)
,p_process_success_message=>'Action Processed.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(21670071347251789)
...
'    p_feedback_id        => :P10014_ID );'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(21648042255251775)
,p_process_success_message=>'Action Processed.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(21670401749251790)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(21670832351251790)
