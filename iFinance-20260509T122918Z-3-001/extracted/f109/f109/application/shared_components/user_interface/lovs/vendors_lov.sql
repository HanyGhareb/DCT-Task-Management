...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(21250598442900808)
,p_lov_name=>'VENDORS LOV'
,p_reference_id=>12585531636422994
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(21253124393900810)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(21253508499900810)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(21253961516900811)
