prompt --application/shared_components/user_interface/lovs/bank_guarantee_types_lov
begin
--   Manifest
--     BANK GUARANTEE TYPES LOV
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(18978266074789)
,p_lov_name=>'BANK GUARANTEE TYPES LOV'
