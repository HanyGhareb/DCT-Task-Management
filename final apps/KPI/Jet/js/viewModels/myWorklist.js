/**
 * Finance KPIs — My Worklist. Deliberately almost empty: the worklist, action
 * bar and timeline are SHARED components over the /wf/ API (see Admin's page).
 */
define(['knockout', 'shared/i18n'], function (ko, i18n) {
  ...
  function MyWorklistViewModel() {
    ...
    // keyed by the BUSINESS record, not an engine instance id
