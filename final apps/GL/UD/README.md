# UD — User Stories (General Ledger, App 210)
...
GL/UD/
  ...
  UD-GL-01_<First-Story-Title>/
    UD-GL-01_<First-Story-Title>.md     ← the story pack (spec + Dev/Test/Deploy trackers)
    assets/                                 ← optional: mockups, diagrams, screenshots
  UD-GL-02_<Next-Story>/
    ...
```

## Naming

- **ID:** `UD-GL-<NN>` — app code + zero-padded 2-digit sequence (`UD-GL-01`, `UD-GL-02`, …).
  Sequence is **global-sequential per app** and never reused.
- **Folder:** `UD-GL-<NN>_<Short-Title-Kebab>`.
...
*No stories yet. The first will be `UD-GL-01_<Short-Title>` — create its folder here when work starts.*
