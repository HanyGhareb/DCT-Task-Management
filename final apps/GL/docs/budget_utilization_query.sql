...
-- PRODUCTIZED: db/v2/37 DCT_BUDGET_UTILIZATION_V is this query + a BUDGET_YEAR
-- dimension (facts year-scoped) -- the view is the source of truth now; this
-- file remains as the documented ad-hoc/all-years variant.
-- ---------------------------------------------------------------------------
