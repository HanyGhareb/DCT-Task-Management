# UD — User Stories (Task Management, App 207)
...
TM/UD/
  ...
  UD-TM-01_<First-Story-Title>/
    UD-TM-01_<First-Story-Title>.md     ← the story pack (spec + Dev/Test/Deploy trackers)
    assets/                                 ← optional: mockups, diagrams, screenshots
  UD-TM-02_<Next-Story>/
    ...
```

## Naming

- **ID:** `UD-TM-<NN>` — app code + zero-padded 2-digit sequence (`UD-TM-01`, `UD-TM-02`, …).
  Sequence is **global-sequential per app** and never reused.
- **Folder:** `UD-TM-<NN>_<Short-Title-Kebab>`.
...
*No stories yet. The first will be `UD-TM-01_<Short-Title>` — create its folder here when work starts.*
