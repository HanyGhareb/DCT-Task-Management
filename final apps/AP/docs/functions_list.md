...
- `fusionUrl(id)` — Oracle Fusion AP_VIEWINVOICE deep-link (config.js `fusionInvoiceUrl` + invoice_id); invoice numbers in the register (all levels), the chart drill drawer and the invoice window open it in a new tab (v1.6.5).
