...
HR/UD/
  ...
  UD-HR-01_<First-Story-Title>/
    UD-HR-01_<First-Story-Title>.md     ← the story pack (spec + Dev/Test/Deploy trackers)
    assets/                                 ← optional: mockups, diagrams, screenshots
  UD-HR-02_<Next-Story>/
    ...
```

## Naming

- **ID:** `UD-HR-<NN>` — app code + zero-padded 2-digit sequence (`UD-HR-01`, `UD-HR-02`, …).
  Sequence is **global-sequential per app** and never reused.
- **Folder:** `UD-HR-<NN>_<Short-Title-Kebab>`.
...
*No stories yet. The first will be `UD-HR-01_<Short-Title>` — create its folder here when work starts.*
