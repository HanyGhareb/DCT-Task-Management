# UD — User Stories (Accounts Receivable, App 206)
...
AR/UD/
  ...
  UD-AR-01_<First-Story-Title>/
    UD-AR-01_<First-Story-Title>.md     ← the story pack (spec + Dev/Test/Deploy trackers)
    assets/                                 ← optional: mockups, diagrams, screenshots
  UD-AR-02_<Next-Story>/
    ...
```

## Naming

- **ID:** `UD-AR-<NN>` — app code + zero-padded 2-digit sequence (`UD-AR-01`, `UD-AR-02`, …).
  Sequence is **global-sequential per app** and never reused.
- **Folder:** `UD-AR-<NN>_<Short-Title-Kebab>`.
...
*No stories yet. The first will be `UD-AR-01_<Short-Title>` — create its folder here when work starts.*
