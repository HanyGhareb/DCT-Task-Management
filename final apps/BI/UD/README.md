# UD — User Stories (BI - Reporting, App 211)
...
BI/UD/
  ...
  UD-BI-01_<First-Story-Title>/
    UD-BI-01_<First-Story-Title>.md     ← the story pack (spec + Dev/Test/Deploy trackers)
    assets/                                 ← optional: mockups, diagrams, screenshots
  UD-BI-02_<Next-Story>/
    ...
```

## Naming

- **ID:** `UD-BI-<NN>` — app code + zero-padded 2-digit sequence (`UD-BI-01`, `UD-BI-02`, …).
  Sequence is **global-sequential per app** and never reused.
- **Folder:** `UD-BI-<NN>_<Short-Title-Kebab>`.
...
*No stories yet. The first will be `UD-BI-01_<Short-Title>` — create its folder here when work starts.*
