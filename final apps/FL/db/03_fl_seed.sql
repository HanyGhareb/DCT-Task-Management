...
-- NOTE: DCT_NATIONALITY seed data is in db/v2/04_dct_seed.sql (section 11).
--       It runs as part of the V2 platform install — no need to seed it here.
...
PROMPT Seeded: FREELANCERS module registration
