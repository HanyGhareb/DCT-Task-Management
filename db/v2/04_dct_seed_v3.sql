-- =============================================================================
-- i-Finance V2 — Seed Data V3 (individual INSERT statements — no INSERT ALL)
-- Schema  : PROD
-- NOTE    : INSERT ALL + GENERATED ALWAYS AS IDENTITY is broken in Oracle 23ai
--           (identity value generated once per statement, not per row).
--           This file uses individual INSERT INTO ... VALUES / SELECT statements.
--           Sections 1, 9, 10 already committed. This covers sections 2-8 + ADMIN fix.
-- =============================================================================
...
-- =============================================================================
-- 2. PLATFORM MODULES (26 rows)
-- =============================================================================
INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('ADMIN','Platform Administration','إدارة المنصة','INTERNAL',200,10,'fa-cogs','#003366','#EEF2F7','User, role, and system administration','إدارة المستخدمين والصلاحيات والإعدادات','ADMIN',0,'Y','Y','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('TASK_MGMT','Task Management','إدارة المهام','APEX_APP',NULL,1,'fa-tasks','#0076CE','#EBF5FB','Weekly Finance Division task tracking','تتبع مهام الأسبوع لقسم المالية','CORE',1,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('HR','HR Organizations','الهياكل التنظيمية','APEX_APP',102,1,'fa-sitemap','#27AE60','#EAFAF1','Organisational structure and HR hierarchy','الهيكل التنظيمي وهرمية الموارد البشرية','HR',10,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('SELF_SERVICE','Employee Self Service','الخدمة الذاتية للموظفين','APEX_APP',106,1,'fa-user-circle','#8E44AD','#F4ECF7','Insurance, housing, missions, and payroll','التأمين والإسكان والمهام والرواتب','HR',11,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('DUTY_HUB','Duty Hub','مركز المهام الرسمية','APEX_APP',810,1,'fa-plane','#E67E22','#FEF9E7','Mission, duty travel, and insurance management','إدارة المهام والسفر الرسمي والتأمين','HR',12,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('HRSS','HR Self Service','الخدمة الذاتية للموارد البشرية','APEX_APP',901,1,'fa-id-badge','#16A085','#E8F8F5','HR petty cash and expense reports','المصروفات النثرية وتقارير المصاريف','HR',13,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('PETTY_CASH','Petty Cash','المصروفات النثرية','APEX_APP',101,1,'fa-money-bill-wave','#1ABC9C','#E8F8F5','Petty cash expense requests and approvals','طلبات واعتماد المصروفات النثرية','HR',14,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('FREELANCERS','Freelancers','المتعاقدون المستقلون','APEX_APP',805,1,'fa-briefcase','#7F8C8D','#F2F3F4','Freelancer and service provider registration','تسجيل المتعاقدين ومقدمي الخدمات','HR',15,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('BUDGET_ALLOC','Budget Allocation','تخصيص الميزانية','APEX_APP',110,1,'fa-chart-pie','#2980B9','#EBF5FB','Budget scenarios and allocation management','سيناريوهات وإدارة تخصيص الميزانية','BUDGET',20,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('BUDGET_PLAN','Budget Planning','تخطيط الميزانية','APEX_APP',115,1,'fa-chart-line','#2471A3','#EBF5FB','Budget planning and forecasting','تخطيط الميزانية والتوقعات المالية','BUDGET',21,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('FUND_MGMT','Fund Management','إدارة الصناديق','APEX_APP',105,1,'fa-exchange-alt','#154360','#EBF5FB','Budget transfers and project fund access','تحويلات الميزانية والوصول إلى صناديق المشاريع','BUDGET',22,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('BUDGET_XFER','Budget Transfer','تحويل الميزانية','APEX_APP',903,1,'fa-arrows-alt-h','#1A5276','#EBF5FB','Budget transfer requests and approvals','طلبات واعتمادات تحويل الميزانية','BUDGET',23,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('PAYMENT_REQ','Payment Requests','طلبات الدفع','APEX_APP',113,1,'fa-file-invoice-dollar','#C0392B','#FDEDEC','PO and GRN-based payment request management','إدارة طلبات الدفع على أساس أوامر الشراء','PAYMENTS',30,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('MANUAL_PR','Manual PR','أوامر الشراء اليدوية','APEX_APP',108,1,'fa-shopping-cart','#CB4335','#FDEDEC','Manual purchase request creation and approval','إنشاء واعتماد أوامر الشراء اليدوية','PAYMENTS',31,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('MGR_CHECKS','Manager Checks','شيكات المدراء','APEX_APP',114,1,'fa-check-square','#B03A2E','#FDEDEC','Manager check requests and approval workflow','طلبات واعتماد شيكات المدراء','PAYMENTS',32,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('BANK_GUAR','Bank Guarantee','الضمانات البنكية','APEX_APP',127,1,'fa-university','#6C3483','#F4ECF7','Bank guarantee request and approval management','إدارة طلبات واعتماد الضمانات البنكية','PAYMENTS',33,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('CREDIT_CARDS','Credit Cards','بطاقات الائتمان','APEX_APP',911,1,'fa-credit-card','#922B21','#FDEDEC','Corporate credit and gift card management','إدارة بطاقات الائتمان والهدايا المؤسسية','PAYMENTS',34,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('PREPAID_CARDS','Prepaid Cards','البطاقات المدفوعة مسبقاً','APEX_APP',104,1,'fa-id-card','#884EA0','#F4ECF7','Prepaid card provisioning','إصدار وإدارة البطاقات المدفوعة مسبقاً','PAYMENTS',35,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('AR','Accounts Receivable','الذمم المدينة','APEX_APP',118,1,'fa-hand-holding-usd','#1F618D','#EBF5FB','AR customer and due transaction management','إدارة عملاء الذمم المدينة والمعاملات المستحقة','PAYMENTS',36,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('CWIP_MGMT','CWIP Payments Management','إدارة مدفوعات قيد التنفيذ','APEX_APP',130,1,'fa-hard-hat','#D35400','#FEF9E7','CWIP project teams, contracts, and payment recommendations','فرق مشاريع قيد التنفيذ والعقود وتوصيات الدفع','CWIP',40,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('CWIP_EX','CWIP Payments (External)','مدفوعات قيد التنفيذ (خارجي)','APEX_APP',109,1,'fa-external-link-alt','#CA6F1E','#FEF9E7','External contractor CWIP payment recommendations','توصيات دفع مقدمي الخدمات الخارجيين لمشاريع قيد التنفيذ','CWIP',41,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('CWIP_CHANGE','CWIP Change Management','إدارة تغييرات قيد التنفيذ','APEX_APP',142,1,'fa-edit','#BA4A00','#FEF9E7','Variation requests, change reasons, and funding sources','طلبات التباين وأسباب التغيير ومصادر التمويل','CWIP',42,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('DEMAND_PLAN','Demand Planning','تخطيط الطلب','APEX_APP',124,1,'fa-boxes','#117A65','#E8F8F5','SCM item categories, budget brackets, and demand forecasting','فئات مواد المشتريات وتخطيط الطلب والتوقعات','SCM',50,'Y','N','SYSTEM');

INSERT INTO PROD.dct_modules (module_code, module_name_en, module_name_ar, module_type, apex_app_id, apex_page_id, icon_class, icon_color, bg_color, description_en, description_ar, category, display_order, is_active, is_admin_only, created_by)
VALUES ('SINGLE_SRC','Single Source (SMD)','المصدر المنفرد','APEX_APP',166,1,'fa-file-contract','#0E6655','#E8F8F5','Single-source procurement exemption requests and TAC committees','طلبات الإعفاء من المصدر المنفرد ولجان TAC','SCM',51,'Y','N','SYSTEM');
...
-- =============================================================================
INSERT INTO PROD.dct_roles (role_code, role_name_en, role_name_ar, role_type, module_id, is_system_role, display_order, created_by)
...
-- =============================================================================
-- 4. PERMISSIONS (22 rows)
-- =============================================================================
INSERT INTO PROD.dct_permissions (permission_code, permission_name, action_type, description_en, created_by)
...
-- =============================================================================
-- 5. ROLE -> PERMISSION MAPPINGS (individual INSERT INTO SELECT)
-- =============================================================================
...
-- =============================================================================
-- 8a. LOOKUP CATEGORIES (8 rows)
-- =============================================================================
INSERT INTO PROD.dct_lookup_categories (category_code, category_name_en, category_name_ar, is_system, created_by)
...
-- =============================================================================
-- 8b. LOOKUP VALUES (individual INSERT INTO SELECT)
-- =============================================================================
...
BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('ADMIN user configured. user_id = ' || l_user_id);
    DBMS_OUTPUT.PUT_LINE('Password set to: iFinance@2026');
    DBMS_OUTPUT.PUT_LINE('*** CHANGE THE PASSWORD BEFORE GOING LIVE ***');
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        DBMS_OUTPUT.PUT_LINE('ERROR: ADMIN user or required role not found.');
        ROLLBACK;
END;
/
...
PROMPT ============================================================
PROMPT  Sprint 1 seed complete.
PROMPT  Admin login: ADMIN / iFinance@2026
