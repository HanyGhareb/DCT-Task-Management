...
--   Authentication Function    : PROD.dct_auth.authenticate
--   Post-Authentication Proc   : PROD.dct_auth.post_login
--
...
CREATE OR REPLACE PACKAGE BODY PROD.dct_auth AS
    ...
    FUNCTION get_user_id (p_username IN VARCHAR2) RETURN NUMBER IS
        l_id PROD.dct_users.user_id%TYPE;
    BEGIN
    ...
    BEGIN
        ...
        INTO   l_roles
        FROM   PROD.v_dct_user_active_roles r
    ...
    BEGIN
        ...
        INTO   l_orgs
        FROM   PROD.dct_user_orgs uo
        JOIN   PROD.dct_users     u  ON uo.user_id = u.user_id
    ...
    BEGIN
        ...
        INTO   l_delegator
        FROM   PROD.v_dct_active_delegations d
    ...
    BEGIN
        ...
        SELECT COUNT(*)
        INTO   l_count
        FROM   PROD.v_dct_user_permissions
        WHERE  UPPER(username)        = UPPER(l_eff)
    ...
    FUNCTION authenticate (p_username IN VARCHAR2, p_password IN VARCHAR2)
        RETURN BOOLEAN
    IS
        l_hash     PROD.dct_users.password_hash%TYPE;
        l_method   PROD.dct_users.auth_method%TYPE;
    ...
    BEGIN
        ...
        BEGIN
            ...
            FROM   PROD.v_dct_active_delegations
    ...
    BEGIN
        ...
        MERGE INTO PROD.dct_sessions s
...
-- =============================================================================
-- SYNONYM for convenience (optional — lets domain apps call PROD.dct_auth without
-- schema prefix if they are in the same schema)
-- =============================================================================
-- CREATE OR REPLACE PUBLIC SYNONYM PROD.dct_auth FOR PROD.dct_auth;
-- GRANT EXECUTE ON PROD.dct_auth TO PUBLIC;  -- restrict to app schema only in prod
