prompt --application/shared_components/reports/report_queries/expensereportdetails3
begin
--   Manifest
--     WEB SERVICE: ExpenseReportDetails3
--   Manifest End
...
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(7468395217852511)
,p_name=>'ExpenseReportDetails3'
...
'and ie.expense_report_id = 9'))
,p_xml_structure=>'APEX'
,p_report_layout_id=>wwv_flow_api.id(7480975598029245)
,p_format=>'PDF'
,p_output_file_name=>'ExpenseReportDetails3'
,p_content_disposition=>'INLINE'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(1390129458913058)
,p_shared_query_id=>wwv_flow_api.id(7468395217852511)
...
'       , ie.employee_sector  , ie.employee_department',
'    -- Approver Details',
'       , h.step_no, h.employee_num , h.user_name, TO_CHAR(h.recevied_date, ''DD-MON-YYYY HH24:MI:SS'') recevied_date, TO_CHAR(h.action_date, ''DD-MON-YYYY HH24:MI:SS'') action_date,',
'       h.status, e.full_name_en approver_name',
'from expense_reports_all_v ie, hrss_expense_report_approval_history h , employees_v e',
'where ie.expense_report_id = h.request_id',
'and h.employee_num = e.employee_num',
'and ie.expense_report_id = nvl(:P35_ID , :P44_ID)'))
);
