prompt --application/shared_components/email/templates/delegate_petty_cash
begin
--   Manifest
--     REPORT LAYOUT: Delegate Petty Cash
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(548407054988200)
,p_name=>'Delegate Petty Cash'
,p_static_id=>'DELEGATE_PETTY_CASH'
