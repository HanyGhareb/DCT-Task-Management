prompt --application/shared_components/email/templates/petty_cash_fbp_email
begin
--   Manifest
--     REPORT LAYOUT: Petty Cash FBP EMail
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(4001911151396403)
,p_name=>'Petty Cash FBP EMail'
,p_static_id=>'PETTY_CASH_FBP_EMAIL'
,p_subject=>'i-Finance: Action Required for Petty Cash Request  for #EMP_NAME# , Amount  #AMOUNT#'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello <b><span style="color: #0e6654;"><i>#FBP_EMP_NAME#,</i></span></b>',
'<br>',
'<br>',
'',
'your kind attention is required to Petty Cash Request# <span style="color: #0e6654;"><i>#PETTY_CASH_NO#</i></span> for employee: <span style="color: #0e6654;"><i>#EMP_NAME#</i></span>',
'<br>',
'<b>Action Required: </b> update the project financial details.',
'<br>',
'',
