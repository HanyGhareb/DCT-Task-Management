prompt --application/shared_components/email/templates/final_approve_petty_cash
begin
--   Manifest
--     REPORT LAYOUT: Final Approve Petty Cash
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(5457377005756066)
,p_name=>'Final Approve Petty Cash'
,p_static_id=>'FINAL_APPROVE_PETTY_CASH'
,p_subject=>'Your Petty Cash# #PETTY_CASH_NO# has been Approved'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello <b><span style="color: #0e6654;"><i>#EMP_NAME#,</i></span></b>',
'<br>',
'',
'Please note that your Petty Cash Request# <span style="color: #0e6654;"><i>#PETTY_CASH_NO#</i></span> has been <span style="color:green;">finally approved</span>.',
'',
'',
...
'</table>',
'<br>',
'you will be updated once finance team process your petty cash payment. you can also folow-up your request status from i-Finance system.',
'<br>',
'<br>',
'<table border="0" align="center">                      ',
'	<tbody><tr>',
'				<td style="padding:16px 24px;border-radius:4px;min-width:200px;" bgcolor="#0e6654" align="center">',
'                          <a rel="nofollow" target="_blank" href="#APPLICATION_LINK#" style="font-size:16px;line-height:16px;font-weight:700;color:#FCFBFA;text-decoration:none;display:inline-block;padding:16px 24px;"> i-Finance System </a>           '
||'             ',
'				</td>                      ',
'			</tr>                    ',
'	</tbody>',
