prompt --application/shared_components/email/templates/final_reject_petty_cash
begin
--   Manifest
--     REPORT LAYOUT: Final Reject Petty Cash
--   Manifest End
...
wwv_flow_api.create_email_template(
 p_id=>wwv_flow_api.id(5457657055875339)
,p_name=>'Final Reject Petty Cash'
,p_static_id=>'FINAL_REJECT_PETTY_CASH'
,p_subject=>'Your Petty Cash# #PETTY_CASH_NO#  has been Rejected'
,p_html_body=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Hello <b><span style="color: #0e6654;"><i>#EMP_NAME#,</i></span></b>',
'<br>',
'',
'Please note that your Petty Cash Request# <span style="color: #0e6654;"><i>#PETTY_CASH_NO#</i></span> has been <span style="color:red;">Rejected</span>.',
'',
'',
...
'<br>',
'',
'you may check the full details for your petty cash request from i-Finance system.',
'<br>',
'<br>',
