...
-- =============================================================================
-- PAGE 1 — Home / App Launcher (Cards region)
-- Builder export: apex-exports/page_1_home_cards.sql
-- Enhancements over raw export:
--   - Icon uses #ICON_CSS_CLASSES# substitution (per-card icon from column)
--   - Card link uses APEX_PAGE.GET_URL for session-safe navigation
--   - New-tab modules open via target="_blank" link attribute
-- =============================================================================
