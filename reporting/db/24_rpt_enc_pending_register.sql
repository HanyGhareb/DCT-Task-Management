...
BEGIN
  ...
  WHEN MATCHED THEN UPDATE SET
     ...
     t.params_json       = '{"year":null,"period":null,"sector":null,"chapter":null,"projecttype":null,"costcenter":null,"project":null,"task":null,"etype":null,"search":null,"source":null}',
     t.updated_by        = 'SETUP',
...
UPDATE prod.dct_rpt_definition
   SET param_spec_json = JSON_MERGEPATCH(
       ...
       '{"source":{"label":"Source (PR / PO)","hint":"Optional. PR = requisitions only, PO = purchase orders only; leave empty for both.","required":false}}')
